...
{
    public partial class CtrlCruzado : System.Web.UI.UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);

        #region DEFINICION DE OBJETOS DE CLASES
        Cliente ObjCliente = new Cliente();
        Cruzado _adminCruzado = new Cruzado();
        #endregion
        ...
        {
            DataTable datos = _adminCruzado.Get(int.Parse(this.CmbCliente.SelectedValue.Trim()), int.Parse(this.TxtVigencia.Text.Trim()), int.Parse(this.TxtPeriodoImpuesto.Text.Trim()));

            datos.Columns[0].ColumnName = "Codigo Empresa";
            datos.Columns[1].ColumnName = "Vigencia";
            datos.Columns[2].ColumnName = "Periodo";
            datos.Columns[3].ColumnName = "Columna 321";
            datos.Columns[4].ColumnName = "Etiqueta 321";
            datos.Columns[5].ColumnName = "Base Resultante";
            datos.Columns[6].ColumnName = "Subcuenta";
            datos.Columns[7].ColumnName = "Nombre Cuenta 525";
            datos.Columns[8].ColumnName = "Valor 321";
            datos.Columns[9].ColumnName = "Valor 525";
            byte[] bytes = MiscReportes.DataTableByArrayBite(datos, true, "|");
            string nombre = "st_validacion_cruzada_f321_525_" + this.TxtPeriodoImpuesto.Text.Trim() + "_" + this.TxtVigencia.Text.Trim() + ".csv";
