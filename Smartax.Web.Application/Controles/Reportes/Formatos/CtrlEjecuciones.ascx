<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlEjecuciones.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Formatos.CtrlEjecuciones" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td colspan="5" align="center" bgcolor="#999999">
                                <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="EJECUCIONES F 321 525" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
