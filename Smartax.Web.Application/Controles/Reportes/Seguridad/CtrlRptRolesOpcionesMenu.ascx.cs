...
{
    public partial class CtrlRptRolesOpcionesMenu : System.Web.UI.UserControl
    {
        ...
        protected void LstPerfiles()
        {
            try
            {
                ObjRol.TipoConsulta = 2;
                ObjRol.IdEstado = 1;
                ObjRol.MostrarSeleccione = "SI";
                ObjRol.IdRol = null;
                ...
                this.CmbPerfil.DataSource = ObjRol.GetRoles();
                this.CmbPerfil.DataValueField = "id_rol";
                this.CmbPerfil.DataTextField = "nombre_rol";
        ...
        protected void LstEstado()
        {
            try
            {
                ...
                ObjEstado.TipoEstado = "INTERFAZ_USER";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Reporte de Perfiles";
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ObjReporte.IdRol = this.CmbPerfil.SelectedValue.ToString().Trim().Length > 0 ? this.CmbPerfil.SelectedValue.ToString().Trim() : null;
                ...
                string _MsgError = "";
                dtDatos = ObjReporte.GetRptRolPermisos(ref _MsgError);
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptPerfiles_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    string strNombreEncabezadoReporte = "REPORTE DE PERFILES Y OPCIONES ASIGNADAS - ESTADO [" + strEstado + "]";
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "LISTA_PERFILES";
                        book.Worksheets["LISTA_PERFILES"].UsedRange.Autofit();
                        Response.Clear();
