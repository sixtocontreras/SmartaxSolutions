<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRptControlActividadesAnalista.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Administrativos.CtrlRptControlActividadesAnalista" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" colspan="3">
                            <asp:Label ID="LblTitulo1" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="14pt">REPORTE CONTROL DE ACTIVIDADES ANALISTA</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <asp:DropDownList ID="CmbAnioGravable" runat="server" Font-Size="14pt" ToolTip="Año Gravable">
                            </asp:DropDownList>
                        </td>
                        <td align="center">
