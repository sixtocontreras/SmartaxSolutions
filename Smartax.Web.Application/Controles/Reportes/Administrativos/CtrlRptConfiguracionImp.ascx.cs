...
{
    public partial class CtrlRptConfiguracionImp : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Reporte de Calendario Tributario";
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string _MsgError = "";
                dtDatos = ObjReporte.GetRptConfiguracionImp(ref _MsgError);
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptConfiguracionImp_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    string _TipoImpuesto = this.CmbTipoImpuesto.SelectedValue.ToString().Trim().Length > 0 ? this.CmbTipoImpuesto.SelectedItem.Text.ToString().Trim() : "";
                    string strNombreEncabezadoReporte = "";
                    if (_TipoImpuesto.ToString().Trim().Length > 0)
                    {
                        strNombreEncabezadoReporte = "REPORTE CONFIGURACION " + _TipoImpuesto + " - ESTADO [" + strEstado + "]";
                    }
                    else
                    {
                        strNombreEncabezadoReporte = "REPORTE CONFIGURACION DE IMPUESTOS - ESTADO [" + strEstado + "]";
                    }
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "CONFIGURACION_IMPUESTO";
                        book.Worksheets["CONFIGURACION_IMPUESTO"].UsedRange.Autofit();
                        Response.Clear();
