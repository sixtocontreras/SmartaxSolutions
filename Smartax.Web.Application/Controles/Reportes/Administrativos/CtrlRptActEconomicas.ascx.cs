...
{
    public partial class CtrlRptActEconomicas : System.Web.UI.UserControl
    {
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string _MsgError = "";
                dtDatos = ObjReporte.GetRptActEconomicas(ref _MsgError);
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptActEconomicas_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    string strNombreEncabezadoReporte = "REPORTE DE ACTIVIDADES ECONOMICAS - ESTADO [" + strEstado + "]";
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "ACTIVIDADES_ECONOMICAS";
                        book.Worksheets["ACTIVIDADES_ECONOMICAS"].UsedRange.Autofit();
                        Response.Clear();
