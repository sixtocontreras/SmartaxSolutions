...
{
    public partial class CtrlRptMunicipioAutoretencion : System.Web.UI.UserControl
    {
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string _MsgError = "";
                dtDatos = ObjReporte.GetRptMunicipioAutoret(ref _MsgError);
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptMunicipiosAutoretenciones_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    string strNombreEncabezadoReporte = "REPORTE DE AUTORETENCIONES POR MUNICIPIOS - ESTADO [" + strEstado + "]";
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "MUNICIPIOS_AUTORETENCIONES";
                        book.Worksheets["MUNICIPIOS_AUTORETENCIONES"].UsedRange.Autofit();
                        Response.Clear();
