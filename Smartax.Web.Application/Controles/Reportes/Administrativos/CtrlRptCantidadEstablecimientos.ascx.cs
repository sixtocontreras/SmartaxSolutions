...
{
    public partial class CtrlRptCantidadEstablecimientos : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Reporte Cantidad de Establecimientos";
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string _MsgError = "";
                dtDatos = ObjReporte.GetRptMunicipiosCantPuntos(ref _MsgError);
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptMunicipioCantEstablecimientos_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    string strNombreEncabezadoReporte = "REPORTE DE CANTIDAD DE ESTABLECIMIENTOS POR MUNICIPIO";
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "CANTIDAD_ESTABLECIMIENTOS";
                        book.Worksheets["CANTIDAD_ESTABLECIMIENTOS"].UsedRange.Autofit();
                        Response.Clear();
