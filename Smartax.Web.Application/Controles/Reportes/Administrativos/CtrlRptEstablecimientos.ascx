<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRptEstablecimientos.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Administrativos.CtrlRptEstablecimientos" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="LblTitulo1" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="14pt">REPORTE DE ESTABLECIMIENTOS</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="Label12" runat="server" Font-Size="14pt" Text="Estado del Establecimiento"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
