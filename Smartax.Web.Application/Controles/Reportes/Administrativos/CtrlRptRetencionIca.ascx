<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRptRetencionIca.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Administrativos.CtrlRptRetencionIca" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="LblTitulo1" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="14pt">REPORTES DE RETENCION DE ICA</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="Label12" runat="server" Font-Size="14pt" Text="Tipo de Reporte"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:DropDownList ID="CmbTipoReporte" runat="server" Font-Size="14pt" ToolTip="Tipo Reporte">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="Label1" runat="server" Font-Size="14pt" Text="Año Gravable"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:DropDownList ID="CmbAnio" runat="server" Font-Size="14pt" ToolTip="Anio Gravable">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="Label2" runat="server" Font-Size="14pt" Text="Mes"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:DropDownList ID="CmbMes" runat="server" Font-Size="14pt" ToolTip="Mes">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
