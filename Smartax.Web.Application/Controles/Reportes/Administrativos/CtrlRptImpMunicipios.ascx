<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRptImpMunicipios.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Administrativos.CtrlRptImpMunicipios" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="LblTitulo1" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="14pt">REPORTE DE IMPUESTOS MUNICIPIO</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
