...
{
    public partial class CtrlRptCalendarioTribututario : System.Web.UI.UserControl
    {
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string _MsgError = "";
                dtDatos = ObjReporte.GetRptCalendarioTribut(ref _MsgError);
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptCalendarioTribut_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "CALENDARIO_TRIBUTARIO";
                        book.Worksheets["CALENDARIO_TRIBUTARIO"].UsedRange.Autofit();
                        Response.Clear();
