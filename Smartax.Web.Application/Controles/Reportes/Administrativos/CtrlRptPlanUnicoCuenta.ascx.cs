...
{
    public partial class CtrlRptPlanUnicoCuenta : System.Web.UI.UserControl
    {
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string _MsgError = "";
                dtDatos = ObjReporte.GetRptPlanUnicoCuenta(ref _MsgError);
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptPlanUnicoCuenta_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    string strNombreEncabezadoReporte = "REPORTE PLAN ÚNICO DE CUENTA - ESTADO [" + strEstado + "]";
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "LISTA_PUC";
                        book.Worksheets["LISTA_PUC"].UsedRange.Autofit();
                        Response.Clear();
