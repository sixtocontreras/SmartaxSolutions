<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRptPlanUnicoCuenta.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Administrativos.CtrlRptPlanUnicoCuenta" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="LblTitulo1" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="14pt">REPORTE PLAN ÚNICO DE CUENTA</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="Label12" runat="server" Font-Size="14pt" Text="Seleccione un Estado de la Lista"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2">
