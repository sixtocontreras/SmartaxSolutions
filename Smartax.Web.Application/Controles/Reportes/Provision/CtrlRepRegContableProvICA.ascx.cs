...
{
    public partial class CtrlRepRegContableProvICA : UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);

        Cliente ObjCliente = new Cliente();
        RegistroContableProv ObjCompProv = new RegistroContableProv();
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            ...
            string nombre = "st_registro_contable_prov_ica_" + ObjCompProv.PeriodoImpuesto.ToString().PadLeft(2, '0') + "_" + ObjCompProv.Vigencia + ".csv";
