<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRepRegContableProvICA.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Provision.CtrlRepRegContableProvICA" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td colspan="5" align="center" bgcolor="#999999">
                                <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REPORTE REGISTRO CONTABLE PROVISIÓN ICA" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label3" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="12pt">Periodo Impuesto</asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <telerik:RadNumericTextBox ID="TxtPeriodoImpuesto1" runat="server" EmptyMessage="Periodo" Font-Size="15pt" Height="30px" MaxLength="2" TabIndex="3" Width="260px">
                                    <NumberFormat GroupSeparator="" DecimalDigits="0" />
                                </telerik:RadNumericTextBox>
                                <asp:RequiredFieldValidator ID="Validador3" runat="server" ControlToValidate="TxtPeriodoImpuesto1" Display="None" ErrorMessage="Campo requerido !" SetFocusOnError="True" ValidationGroup="ValidarDatos"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
