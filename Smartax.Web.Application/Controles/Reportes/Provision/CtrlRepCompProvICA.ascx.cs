...
{
    public partial class CtrlRepCompProvICA : UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);

        Cliente ObjCliente = new Cliente();
        CompProv ObjCompProv = new CompProv();
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            ...
            string nombre = "st_comp_prov_ica_" + ObjCompProv.PeriodoImpuesto.ToString().PadLeft(2,'0') + "_" + ObjCompProv.Vigencia + ".csv";
