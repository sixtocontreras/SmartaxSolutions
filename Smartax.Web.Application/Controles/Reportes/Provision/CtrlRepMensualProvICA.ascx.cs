...
{
    public partial class CtrlRepMensualProvICA : System.Web.UI.UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);

        Cliente ObjCliente = new Cliente();
        MensualProv ObjCompProv = new MensualProv();
        ...
        protected void BtnGenerar_Click(object sender, EventArgs e)
        {
            ...
            string nombre = "st_reporte_mensual_prov_ica_" + ObjCompProv.PeriodoImpuesto.ToString().PadLeft(2, '0') + "_" + ObjCompProv.Vigencia + ".csv";
