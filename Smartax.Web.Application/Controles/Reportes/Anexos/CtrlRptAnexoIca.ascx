<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlRptAnexoIca.ascx.cs" Inherits="Smartax.Web.Application.Controles.Reportes.Anexos.CtrlRptAnexoIca" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" colspan="2">
                            <asp:Label ID="LblTitulo1" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="14pt">REPORTE LIQUIDACIÓN DEL ICA</asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="center" class="auto-style1">
                            <asp:Label ID="Label13" runat="server" Font-Size="14pt" Text="Estado de la Liquidación"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td align="center">
                            <asp:DropDownList ID="CmbEstado" runat="server" Font-Size="15pt" ToolTip="Estado de la liquidación">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
