...
namespace Smartax.Web.Application.Controles.Reportes.Anexos
{
    public partial class CtrlRptAnexoIca : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Reporte Liquidación Ica";
