...
namespace Smartax.Web.Application.Controles.Seguridad
{
    public partial class FrmLogsAuditoria : System.Web.UI.Page
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjAuditoria.TipoConsulta = 1;
                ObjAuditoria.IdTipoEvento = null;
                ObjAuditoria.ModuloApp = this.ViewState["ModuloApp"].ToString().Trim();
                ObjAuditoria.FechaInicial = DateTime.Now.ToString("yyyy-MM-dd") + " 00:00:00";
                ObjAuditoria.FechaFinal = DateTime.Now.ToString("yyyy-MM-dd") + " 23:59:59";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!(this.Page.IsPostBack))
            {
                ...
                this.ViewState["ModuloApp"] = Request.QueryString["ModuloApp"].ToString().Trim();
            }
            else
            {
                ObjUtils.CambiarGrillaAEspanol(RadGrid1);
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                this.RadGrid1.DataMember = "DtAuditoria";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error con el evento NeedDataSource del Impuesto del municipio. Motivo: " + ex.ToString();
                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                Ventana.ID = "RadWindow2";
                Ventana.VisibleOnPageLoad = true;
                Ventana.Visible = true;
