<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLogsAuditoria.aspx.cs" Inherits="Smartax.Web.Application.Controles.Seguridad.FrmLogsAuditoria" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" bgcolor="#999999">
                            <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="DETALLE LOGS DE AUDITORIA" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                                ...
                                <MasterTableView DataKeyNames="idlog_auditoria" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="descripcion_evento" HeaderText="Descripción"
                                            UniqueName="descripcion_evento" FilterControlWidth="150px">
                                        </telerik:GridBoundColumn>
