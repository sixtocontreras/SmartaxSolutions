<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDescargar321.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.Formatos.frmDescargar321" %>
                            ...
                            <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                                <tr>
                                    <td align="center" colspan="3" bgcolor="#999999">
                                        <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="DESCARGAR FORMATO 321" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
