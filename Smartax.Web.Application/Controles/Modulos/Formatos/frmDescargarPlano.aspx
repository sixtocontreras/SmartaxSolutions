<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDescargarPlano.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.Formatos.frmDescargarPlano" %>
                           ...
                           <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                                <tr>
                                    <td align="center" colspan="3" bgcolor="#999999">
                                        <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="DESCARGAR ARCHIVO PLANO" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:Button ID="BtnEjecutar" runat="server" Font-Bold="True" Font-Size="14pt" Text="Descargar" ToolTip="Click para ejecutar el proceso de generacion de F-321/525" Width="120px" OnClick="BtnEjecutar_Click" ValidationGroup="ValidarDatos" />
