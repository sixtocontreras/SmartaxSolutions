...
{
    public partial class frmDescargar321 : System.Web.UI.Page
    {
        ...
        protected void BtnEjecutar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var fileName = Server.MapPath($"../../../Archivos/Formatos/{CmbCliente.SelectedValue}/F321_{nom_mes}_{TxtVigencia.Text}.xlsx");
                ...
                {
                    string baseUrl = $"{ConfigurationManager.AppSettings["UrlBase"]}/Archivos/Formatos/{CmbCliente.SelectedValue}/F321_{nom_mes}_{TxtVigencia.Text}.xlsx";
