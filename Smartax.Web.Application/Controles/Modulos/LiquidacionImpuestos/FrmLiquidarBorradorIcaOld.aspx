<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLiquidarBorradorIcaOld.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmLiquidarBorradorIcaOld" %>
                            ...
                            <table cellpadding="4" cellspacing="0" class="Tab" border="1" style="width: 1200px;">
                                <tr>
                                    <td colspan="13" align="center" bgcolor="#999999">
                                        <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="HOJA DE TRABAJO LIQUIDACION DE IMPUESTO DEL ICA" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2" colspan="2">
                                        ...
                                        <asp:ImageButton ID="BtnConsultar" runat="server" ImageUrl="~/Imagenes/Iconos/32/img_search.png" OnClick="BtnConsultar_Click" ToolTip="Click para realizar proceso de liquidación" />
                                ...
                                <tr>
                                    <td colspan="9" align="center">
                                        <asp:RadioButtonList ID="RbPeriodoImpuesto" runat="server" RepeatDirection="Horizontal" Width="550px">
                                            ...
                                            <asp:ListItem Value="7" Selected="True">anual</asp:ListItem>
                                        </asp:RadioButtonList>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" rowspan="2">
                                        <asp:RadioButton ID="RbDeclaracionInicial" runat="server" Font-Size="8pt" OnCheckedChanged="RbDeclaracionInicial_CheckedChanged" Text="DECLARACIÓN INICIAL" AutoPostBack="True" Checked="True" />
                                        &nbsp;<asp:RadioButton ID="RbSoloPago" runat="server" AutoPostBack="True" Font-Size="8pt" OnCheckedChanged="RbSoloPago_CheckedChanged" Text="SOLO PAGO" />
                                        &nbsp;<asp:RadioButton ID="RbCorreccion" runat="server" AutoPostBack="True" Font-Size="8pt" OnCheckedChanged="RbCorreccion_CheckedChanged" Text="CORRECCIÓN" />
                                ...
                                <tr>
                                    ...
                                    <td colspan="5">
                                        ...
                                        <asp:RadioButton ID="RbExtemporaneidad" runat="server" Font-Size="8pt" Text="Extemporaneidad" AutoPostBack="True" OnCheckedChanged="RbExtemporaneidad_CheckedChanged" />
                                        &nbsp;<asp:RadioButton ID="RbCorreccion2" runat="server" Font-Size="8pt" Text="Corrrección" AutoPostBack="True" OnCheckedChanged="RbCorreccion2_CheckedChanged" />
                                        &nbsp;<asp:RadioButton ID="RbInexactitud" runat="server" Font-Size="8pt" Text="Inexactitud" AutoPostBack="True" OnCheckedChanged="RbInexactitud_CheckedChanged" />
                                        &nbsp;<asp:RadioButton ID="RbOtra" runat="server" Font-Size="8pt" Text="Otra" AutoPostBack="True" OnCheckedChanged="RbOtra_CheckedChanged" />
                                        &nbsp;
                                <asp:Label ID="Label91" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="7pt">Cuál:</asp:Label>
                                    ...
                                    <td colspan="6" align="right">&nbsp;<telerik:RadNumericTextBox ID="TxtValorRenglon31" runat="server" AutoPostBack="True" EmptyMessage="Valor" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="10" MinValue="0" Value="0" Width="160px" OnTextChanged="TxtValorRenglon31_TextChanged" TabIndex="7">
                                ...
                                <tr>
                                    ...
                                    <td colspan="6" align="right">
                                        <telerik:RadNumericTextBox ID="TxtValorRenglon37" runat="server" EmptyMessage="Intereses" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="10" MinValue="0" Value="0" Width="160px" AutoPostBack="True" OnTextChanged="TxtValorRenglon37_TextChanged" TabIndex="8">
                                            <NegativeStyle Resize="None" HorizontalAlign="Right" />
                                            <NumberFormat DecimalDigits="0" ZeroPattern="n" />
                                            <EmptyMessageStyle Resize="None" />
                                            <ReadOnlyStyle Resize="None" />
                                            <FocusedStyle Resize="None" />
                                ...
                                <tr>
                                    ...
                                    <td colspan="6" align="right">
                                        <telerik:RadNumericTextBox ID="TxtValorRenglon39" runat="server" AutoPostBack="True" EmptyMessage="Pago Voluntario" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="10" MinValue="0" OnTextChanged="TxtValorRenglon39_TextChanged" TabIndex="9" Value="0" Width="160px">
                                            <NegativeStyle HorizontalAlign="Right" Resize="None" />
                                            <NumberFormat DecimalDigits="0" ZeroPattern="n" />
                                            <EmptyMessageStyle Resize="None" />
                                            <ReadOnlyStyle Resize="None" />
                                ...
                                <tr>
                                    ...
                                    <td align="right" colspan="9">
                                        ...
                                        <telerik:RadTextBox ID="TxtDestinoAporteVl" runat="server" EmptyMessage="Destino del Aporte Voluntario" Font-Size="13pt" Height="25px" MaxLength="250" TabIndex="10" Width="450px">
                                            <EmptyMessageStyle Resize="None" />
                                            <ReadOnlyStyle Resize="None" />
                                            <FocusedStyle Resize="None" />
                                            <DisabledStyle HorizontalAlign="Center" Resize="None" />
                                            ...
                                            <table border="1" style="width: 100%;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <br />
                                                        <telerik:RadBinaryImage ID="ImgFirma2" runat="server" Height="40px" ResizeMode="Fill" Width="180px" Visible="False" />
                                                        <br />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        &nbsp;<asp:DropDownList ID="CmbFirmante2" runat="server" Font-Size="15pt" TabIndex="1" ToolTip="Seleccione un nombre" AutoPostBack="True" OnSelectedIndexChanged="CmbFirmante2_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        &nbsp;<asp:Button ID="BtnGuardar" runat="server" Font-Bold="True" Font-Size="14pt" Height="40px" OnClick="BtnGuardar_Click" Text="Guardar Borrador" ToolTip="Click para guardar borrador del formularion del ICA" ValidationGroup="ValidarDatos" Width="200px" />
                                                        &nbsp;<asp:Button ID="BtnNuevaLiquidacion" runat="server" Font-Bold="True" Font-Size="14pt" Height="40px" OnClick="BtnNuevaLiquidacion_Click" Text="Nueva Liquidación" ToolTip="Click para realizar nueva liquidación" Width="200px" Enabled="False" />
