<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmEjecucionPorLote.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmEjecucionPorLote" %>
                        ...
                        <asp:Panel ID="PnlDatos" runat="server" Width="100%" HorizontalAlign="Center">
                            <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td align="center">&nbsp;&nbsp;<asp:DropDownList ID="CmbTipoImpuesto" runat="server" AutoPostBack="True" Font-Size="15pt" OnSelectedIndexChanged="CmbTipoImpuesto_SelectedIndexChanged" TabIndex="2" ToolTip="Seleccione el formulario aplicar en el filtro">
                                        </asp:DropDownList>
                                    ...
                                    <td colspan="2" align="center">
                                        <asp:DropDownList ID="CmbDepartamento" runat="server" AutoPostBack="True" Font-Size="15pt" OnSelectedIndexChanged="CmbDepartamento_SelectedIndexChanged" TabIndex="3" ToolTip="Seleccione el departamento">
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td align="center" colspan="2">
                                        <asp:Label ID="Label26" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="12pt">Año Gravable</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:DropDownList ID="CmbMunicipio" runat="server" AutoPostBack="True" Font-Size="15pt" OnSelectedIndexChanged="CmbMunicipio_SelectedIndexChanged" TabIndex="4" ToolTip="Seleccione el municipio">
                                        </asp:DropDownList>
                                    ...
                                    <td align="center">
                                        <asp:RadioButtonList ID="RbEstadoDeclaracion" runat="server" RepeatDirection="Horizontal" TabIndex="5" ToolTip="Es consorcio unión temporal ?" Enabled="False">
                                    ...
                                    <td align="center" colspan="2">
                                        <asp:DropDownList ID="CmbAnioGravable" runat="server" Font-Size="15pt" TabIndex="6" ToolTip="Seleccione el año gravable del impuesto">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="Validador7" runat="server" ControlToValidate="CmbAnioGravable" Display="None" ErrorMessage="Campo requerido !" SetFocusOnError="True" ValidationGroup="ValidarDatos"></asp:RequiredFieldValidator>
                                ...
                                <tr>
                                    <td align="center" colspan="4">
                                        <telerik:RadTextBox ID="TxtEmailsConfirmacion" runat="server" EmptyMessage="email1@dominio.com;email2@dominio.com.co;email3@dominio.net;email4@dominio.gov" Font-Size="15pt" Height="60px" MaxLength="1000" TabIndex="7" TextMode="MultiLine" Width="600px">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:Button ID="BtnEjecutar" runat="server" Font-Bold="True" Font-Size="14pt" OnClick="BtnEjecutar_Click" Text="Ejecutar Proceso" ToolTip="Click para ejecutar el proceso por Lote" ValidationGroup="ValidarDatos" Width="180px" Height="40px" TabIndex="8" />
