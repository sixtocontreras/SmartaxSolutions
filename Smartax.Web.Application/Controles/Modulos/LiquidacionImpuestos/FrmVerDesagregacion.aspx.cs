...
{
    public partial class FrmVerDesagregacion : System.Web.UI.Page
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ...
                ObjConsulta.AnioGravable = this.ViewState["AnioGravable"].ToString().Trim();
                ...
                ObjetoDataTable = ObjConsulta.GetConsultarActEconomica();
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                this.RadGrid1.DataMember = "DtConsultarActEconomica";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
