<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLiquidarBorradorAutoIca.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmLiquidarBorradorAutoIca" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" border="1" style="width: 1200px;">
                        <tr>
                            <td colspan="13" align="center" bgcolor="#999999">
                                <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="HOJA DE TRABAJO PARA LA LIQUIDACIÓN" Font-Bold="True" Font-Size="14pt" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                &nbsp;<asp:Button ID="BtnNuevaLiquidacion" runat="server" Enabled="False" Font-Bold="True" Font-Size="14pt" Height="40px" OnClick="BtnNuevaLiquidacion_Click" Text="Nueva Liquidación" ToolTip="Click para realizar nueva liquidación" Width="200px" />
