<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmVerLiquidarDefinitivoIcaOld.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmVerLiquidarDefinitivoIcaOld" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" border="1" style="width: 1200px;">
                        ...
                        <tr>
                            <td colspan="9" align="center">
                                <asp:RadioButtonList ID="RbPeriodoImpuesto" runat="server" RepeatDirection="Horizontal" Width="550px" Enabled="False">
