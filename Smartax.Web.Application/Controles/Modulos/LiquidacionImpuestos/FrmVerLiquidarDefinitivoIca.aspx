<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmVerLiquidarDefinitivoIca.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmVerLiquidarDefinitivoIca" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" border="1" style="width: 1200px;">
                        <tr>
                            <td colspan="13" align="center" bgcolor="#999999">
                                <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="VER LIQUIDACION DEFINITIVA DE IMPUESTO DEL ICA" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="9" align="center">
                                ...
                                <asp:RadioButtonList ID="RbPeriodoTrimestral" runat="server" RepeatDirection="Horizontal" Visible="False" Width="750px">
                                ...
                                <asp:RadioButtonList ID="RbPeriodoCuatrimestral" runat="server" RepeatDirection="Horizontal" Visible="False" Width="700px">
                                ...
                                <asp:RadioButtonList ID="RbPeriodoSemestral" runat="server" RepeatDirection="Horizontal" Visible="False" Width="700px">
                                    ...
                                    <table border="1" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                &nbsp;<asp:Label ID="LblNombreFirmante1" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="7pt"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label112" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="7pt">NOMBRE:</asp:Label>
                                                &nbsp;<asp:Label ID="LblNombreFirmante2" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="7pt"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <asp:RadioButton ID="RbTarjetaProfFirm2" runat="server" Font-Size="8pt" Text="T.P." />
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                &nbsp;<asp:Button ID="BtnVerFormulario" runat="server" Font-Bold="True" Font-Size="14pt" Height="40px" OnClick="BtnVerFormulario_Click" Text="Ver Formulario" ToolTip="Click para ver formulario Definitivo del ICA" ValidationGroup="ValidarDatos" Width="200px" />
