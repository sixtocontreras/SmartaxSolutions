<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPageGeneral.Master" CodeBehind="FrmCargaLeasingHabitacional.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmCargaLeasingHabitacional" %>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td align="center" colspan="3" bgcolor="#999999">
                                <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="CARGUE MASIVO LEASING HABITACIONAL" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
