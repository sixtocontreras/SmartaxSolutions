...
{
    public partial class FrmVerDetalleCuentas : System.Web.UI.Page
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjBaseGrav.TipoConsulta = 4;
                ObjBaseGrav.IdCliente = this.ViewState["IdCliente"] != null ? this.Session["IdCliente"].ToString().Trim() : null;
                ObjBaseGrav.IdClienteEstablecimiento = this.ViewState["IdClienteEstablecimiento"].ToString().Trim();
                ...
                ObjBaseGrav.AnioGravable = null;
                ObjBaseGrav.MesEf = null;
                ObjBaseGrav.IdEstado = 1;
                ObjBaseGrav.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();

                ObjetoDataTable = ObjBaseGrav.GetBaseGravableCuentas();
                ...
                else
                {
                    ...
                    RadWindow Ventana = new RadWindow();
                    Ventana.Modal = true;
                    string _MsgMensaje = "Señor usuario. no se encontraron cuentas asociadas. Por favor validar nuevamente !";
