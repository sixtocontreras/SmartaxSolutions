<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLiquidarDefinitivoAutoIca.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmLiquidarDefinitivoAutoIca" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" border="1" style="width: 1200px;">
                        ...
                        <tr>
                            <td colspan="10" align="center">
                                ...
                                <asp:RadioButtonList ID="RbPeriodoTrimestral" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RbPeriodoTrimestral_SelectedIndexChanged" RepeatDirection="Horizontal" Visible="False" Width="1100px">
                                ...
                                <asp:RadioButtonList ID="RbPeriodoCuatrimestral" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RbPeriodoCuatrimestral_SelectedIndexChanged" RepeatDirection="Horizontal" Visible="False" Width="1100px">
                                ...
                                <asp:RadioButtonList ID="RbPeriodoSemestral" runat="server" AutoPostBack="True" OnSelectedIndexChanged="RbPeriodoSemestral_SelectedIndexChanged" RepeatDirection="Horizontal" Visible="False" Width="1000px">
                        ...
                        <tr>
                            ...
                            <td align="right" colspan="7">
                                <telerik:RadNumericTextBox ID="TxtValorRenglon39" runat="server" AutoPostBack="True" EmptyMessage="Valor" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="10" MinValue="0" OnTextChanged="TxtValorRenglon39_TextChanged" TabIndex="7" Value="0" Width="160px">
                        ...
                        <tr>
                            ...
                            <td colspan="7" align="right">
                                <telerik:RadNumericTextBox ID="TxtValorRenglon43" runat="server" AutoPostBack="True" EmptyMessage="Intereses" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="10" MinValue="0" OnTextChanged="TxtValorRenglon43_TextChanged" TabIndex="8" Value="0" Width="160px">
                                    <NegativeStyle HorizontalAlign="Right" Resize="None" />
                                    <NumberFormat DecimalDigits="0" ZeroPattern="n" />
                                    <EmptyMessageStyle Resize="None" />
                                    <ReadOnlyStyle Resize="None" />
                                ...
                                <asp:Panel ID="Panel1" runat="server">
                                    <table border="1" style="width: 100%;">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButton ID="RbFirmaContador" runat="server" AutoPostBack="True" Font-Size="8pt" OnCheckedChanged="RbFirmaContador_CheckedChanged" Text="FIRMA DEL CONTADOR" />
                                                <asp:RadioButton ID="RbFirmaRevFiscal" runat="server" AutoPostBack="True" Font-Size="8pt" OnCheckedChanged="RbFirmaRevFiscal_CheckedChanged" Text="REVISOR FISCAL" />
                                                <br />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                &nbsp;<asp:DropDownList ID="CmbFirmante2" runat="server" Font-Size="15pt" TabIndex="1" ToolTip="Seleccione un nombre de firmante" AutoPostBack="True" OnSelectedIndexChanged="CmbFirmante2_SelectedIndexChanged">
                                                </asp:DropDownList>
                                    ...
                                    <table style="width:100%;">
                                        ...
                                        <tr>
                                            <td align="center">
                                                ...
                                                &nbsp;<asp:Button ID="BtnGuardar" runat="server" Font-Bold="True" Font-Size="14pt" Height="40px" OnClick="BtnGuardar_Click" Text="Guardar Definitivo" ToolTip="Click para guardar definitivo del formularion del Auto Ica" ValidationGroup="ValidarDatos" Width="200px" />
                                                &nbsp;<asp:Button ID="BtnVerFormulario" runat="server" Font-Bold="True" Font-Size="14pt" Height="40px" OnClick="BtnVerFormulario_Click" Text="Ver Formulario" ToolTip="Click para visualizar el formulario definitivo" Width="200px" Visible="False" />
                                                &nbsp;<asp:Button ID="BtnNuevaLiquidacion" runat="server" Enabled="False" Font-Bold="True" Font-Size="14pt" Height="40px" OnClick="BtnNuevaLiquidacion_Click" Text="Nueva Consulta" ToolTip="Click para realizar nueva liquidación" Width="200px" />
