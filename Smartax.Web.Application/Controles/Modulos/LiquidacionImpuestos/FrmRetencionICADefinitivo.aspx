<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmRetencionICADefinitivo.aspx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.LiquidacionImpuestos.FrmRetencionICADefinitivo" %>
                ...
                <asp:Panel ID="PnlDatos" runat="server" Visible="false" Width="1250px" HorizontalAlign="Center" BorderStyle="Solid">
                    <table cellpadding="4" cellspacing="0" class="Tab" border="1" style="width: 1200px;">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <telerik:RadNumericTextBox ID="TxtCodDane" OnTextChanged="TxtCodDane_TextChanged" runat="server" AutoPostBack="True" EmptyMessage="Cod. Dane" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="10" MinValue="1" TabIndex="1" Width="120px" DataType="System.Int32">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <telerik:RadNumericTextBox ID="TxtAnioGravable" OnTextChanged="TxtAnioGravable_TextChanged" runat="server" EmptyMessage="Año Gravable" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="4" MinValue="1" TabIndex="2" Width="120px" AutoPostBack="True" >
                                    <NegativeStyle Resize="None" />
                                    <NumberFormat DecimalDigits="0" ZeroPattern="n" />
                                    <EmptyMessageStyle Resize="None" />
                                    <ReadOnlyStyle Resize="None" />
                            ...
                            <td align="center" colspan="2">
                                <asp:DropDownList ID="ddlPeriodoDeclarar" OnSelectedIndexChanged="ddlPeriodoDeclarar_SelectedIndexChanged" AutoPostBack="true" Width="70%" Visible="false" runat="server" Font-Size="15pt" TabIndex="1" ToolTip="Seleccione" >
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="6">
                                <asp:RadioButton ID="rbInicial" GroupName="opcionuso" AutoPostBack="true"  Text="Inicial" runat="server" Checked="false"></asp:RadioButton>
                                <asp:RadioButton ID="rbPago" GroupName="opcionuso" AutoPostBack="true"  Text="Pago" runat="server" Checked="false"></asp:RadioButton>
                                <asp:RadioButton ID="rbCorreccion" GroupName="opcionuso" AutoPostBack="true" Text="Corrección" runat="server" Checked="false" ></asp:RadioButton>
                            </td>
                            <td>
                                <asp:Label ID="Label15" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="8pt">Formulario anterior:</asp:Label>
                                                            
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtFormularioAnterior" runat="server" EmptyMessage="Formulario anterior" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="4" MinValue="1" TabIndex="2" Width="120px" AutoPostBack="false">
                                    <NegativeStyle Resize="None" />
                                    <NumberFormat DecimalDigits="0" ZeroPattern="n" />
                                    <EmptyMessageStyle Resize="None" />
                                    <ReadOnlyStyle Resize="None" />
                            ...
                            <td>
                                <asp:Label ID="Label16" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="8pt">Fecha de presentación</asp:Label>
                        ...
                        <tr>
                            ...
                            <td colspan="7">
                                <asp:Label ID="Label21" runat="server" CssClass="FormLabels" Font-Size="11pt">Base de retención por actividades industriales</asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="right">
                                <asp:Label ID="lblRenglon37" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="12pt"></asp:Label>
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="right">
                                <asp:Label ID="lblRenglon40" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="12pt"></asp:Label>
                        ...
                        <tr>
                            ...
                            <td colspan="2" align="right">
                                <asp:Label ID="lblRenglon41" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="12pt"></asp:Label>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <asp:DropDownList ID="ddlFirmante" Enabled="false" runat="server" AutoPostBack="true"  Font-Size="15pt" TabIndex="1" ToolTip="Seleccione...">
                                </asp:DropDownList>
                            </td>
                            <td colspan="6">
                                <asp:Label ID="Label40" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="11pt">Nombre</asp:Label>
                                <asp:DropDownList ID="ddlContador" Enabled="false" runat="server" AutoPostBack="true"  Font-Size="15pt" TabIndex="1" ToolTip="Seleccione...">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="center" colspan="11">
                                <asp:Panel ID="Panel3" runat="server">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td align="center">
                                                <asp:Button ID="BtnGuardar" Visible="false" runat="server" Font-Bold="True" Font-Size="14pt" Height="40px" Text="Guardar" ToolTip="Click para guardar el definitivo del formularion del alumbrado" Enabled="false" ValidationGroup="ValidarDatos" Width="200px"  />
                                                <telerik:RadButton Font-Bold="True" Text="Borrar" Visible="false" ID="BtnBorrar" runat="server" Font-Size="14pt" Height="40px" ToolTip="Click para borrar el formulario" Width="200px" Enabled="true" >
                                                    <ConfirmSettings Title="Confirmación" ConfirmText="¿Esta seguro que desea eliminar este formulario de liquidación?" />
                                                </telerik:RadButton>
                                                &nbsp;<asp:Button ID="btnPdf" runat="server" OnClick="btnPdf_Click" Font-Bold="True" Font-Size="14pt" Height="40px" Text="Descargar pdf" ToolTip="Click para descargar el formulartio" Width="200px" />
