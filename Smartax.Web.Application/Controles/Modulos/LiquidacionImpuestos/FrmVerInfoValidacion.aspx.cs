...
{
    public partial class FrmVerInfoValidacion : System.Web.UI.Page
    {
        ...
        public DataSet GetInfoValidacion()
        {
            DataSet ObjetoDataSet = new DataSet();
            DataTable ObjetoDataTable = new DataTable();
            try
            {
                //--OBTENER DATOS DE LA DB DE POSTGRESQL
                ObjEjecFiltros.TipoConsulta = 2;
                ObjEjecFiltros.IdLiquidacionLote = Request.QueryString["IdLiquidacionLote"].ToString().Trim();
                ObjEjecFiltros.IdEjecucionLote = null;
                ObjEjecFiltros.AnioGravable = Request.QueryString["AnioGravable"].ToString().Trim();
                ObjEjecFiltros.IdFormImpuesto = Request.QueryString["IdFormImpuesto"].ToString().Trim();
                ObjEjecFiltros.IdDepartamento = Request.QueryString["IdDepartamento"].ToString().Trim();
                ObjEjecFiltros.IdEstado = null;
                ObjEjecFiltros.MotorBaseDatos = FixedData.BaseDatosUtilizar.ToString().Trim();

                string _MsgError = "";
                ObjetoDataTable = ObjEjecFiltros.GetInfoValidacionLiquidacionXLote(ref _MsgError);
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idliquidacion_lote"] };
        ...
        private DataSet FuenteDatos
        {
            get
            {
                ...
                else
                {
                    ...
                    ConjuntoDatos = GetInfoValidacion();
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtLiquidacionXLote";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
