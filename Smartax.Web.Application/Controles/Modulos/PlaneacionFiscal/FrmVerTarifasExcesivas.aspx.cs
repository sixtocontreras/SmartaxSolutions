...
{
    public partial class FrmVerTarifasExcesivas : System.Web.UI.Page
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ...
                ObjetoDataTable = ObjModulo.GetTarifasExcesivas();
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                this.RadGrid1.DataMember = "DtTarifasExcesivas";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
        ...
        protected void ExportarDatosExcel(DataTable DtDatosExportar)
        {
            try
            {
                if (DtDatosExportar.Rows.Count > 0)
                {
                    ...
                    string cNombreFileExcel = "RptTarifasExcesivas_" + _DiaActual + "_" + _MesActual + ".xlsx";
                    ...
                    string strNombreEncabezadoReporte = "TARIFAS DE LEY Y EXCESIVAS POR MUNICIPIO";
                    ...
                    if (Contador > 0)
                    {
                        ...
                        book.Worksheets["Sheet1"].Name = "TARIFAS_EXCESIVAS";
                        book.Worksheets["TARIFAS_EXCESIVAS"].UsedRange.Autofit();
                        Response.Clear();
