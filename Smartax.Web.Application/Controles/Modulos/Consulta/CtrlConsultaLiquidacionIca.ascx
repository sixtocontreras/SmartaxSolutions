<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlConsultaLiquidacionIca.ascx.cs" Inherits="Smartax.Web.Application.Controles.Modulos.Consulta.CtrlConsultaLiquidacionIca" %>
...
<body bgcolor="#E6E6E6">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Width="100%" HorizontalAlign="NotSet">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:Panel ID="Panel1" runat="server" DefaultButton="BtnConsultar">
                    <table cellpadding="4" cellspacing="0" class="Tab" border="0" style="width: 100%;">
                        ...
                        <tr>
                            <td align="center">
                                <asp:Panel ID="Panel2" runat="server" DefaultButton="BtnConsultar">
                                    <table cellpadding="4" cellspacing="0" class="Tab" border="0" style="width: 100%;">
                                        <tr>
                                            <td align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <asp:DropDownList ID="CmbUsuarios" runat="server" AutoPostBack="True" Font-Size="15pt" OnSelectedIndexChanged="CmbTipoImpuesto_SelectedIndexChanged" TabIndex="2" ToolTip="Seleccione el usuario de la Lista">
                                                </asp:DropDownList>
                                            </td>
                                            <td align="center">
                                            ...
                                            <td align="center">
                                                ...
                                                <asp:RequiredFieldValidator ID="Validador2" runat="server" ControlToValidate="TxtAnioGravable" Display="None" ErrorMessage="Campo requerido !" SetFocusOnError="True" ValidationGroup="ValidarDatos"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            <td align="center">
                                <asp:Label ID="Label3" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="10pt">Nota:</asp:Label>
                                &nbsp;<asp:Label ID="Label4" runat="server" CssClass="FormLabels" Font-Bold="False" Font-Size="10pt">Señor usuario, tenga en cuenta que el sistema por default consulta las liquidaciones del año anterior si desea consulta de otros años podrá ingresarlo en la casilla de Año Gravable y luego dar click en el boton Consultar.</asp:Label>
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
