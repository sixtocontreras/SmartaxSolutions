...
{
    public partial class CtrlFichaTecnicaMunicipio : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ...
                ObjMunicipio.CodigoDane = null;
                ObjMunicipio.NombreMunicipio = null;
                ObjMunicipio.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los tipos de monedas
                ObjetoDataTable = ObjMunicipio.GetMunicipiosFichaTecnica();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_registro, id_municipio"] };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Ficha técnica";
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                this.RadGrid1.DataMember = "DtFichaTecnica";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                ...
                {
                    #region MOSTRAR EL FORMULARIO DE LA FICHA TECNICA
                    ...
                    Ventana.NavigateUrl = "/Controles/Modulos/Consulta/FrmVerFichaTecnica.aspx?IdMunicipio=" + _IdMunicipio;
                    ...
                    Ventana.KeepInScreenBounds = true;
                    Ventana.Title = "Ficha Técnica del Municipio: " + _NombreMunicipio;
                    Ventana.VisibleStatusbar = false;
                    Ventana.Behaviors = WindowBehaviors.Close;
                    this.RadWindowManager1.Windows.Add(Ventana);
                    this.RadWindowManager1 = null;
