...
{
    public partial class FrmVerDetalleLiquidacion : System.Web.UI.Page
    {
        ...
        public DataSet GetInfoLiquidacion()
        {
            DataSet ObjetoDataSet = new DataSet();
            DataTable ObjetoDataTable = new DataTable();
            try
            {
                ObjLiqImpuesto.TipoConsulta = 4;
                ObjLiqImpuesto.IdFormularioImpuesto = Request.QueryString["IdFormImpuesto"].ToString().Trim();
                ObjLiqImpuesto.IdLiquidImpuesto = Request.QueryString["IdLiquidImpuesto"].ToString().Trim();
                ...
                ObjLiqImpuesto.AnioGravable = Request.QueryString["AnioGravable"].ToString().Trim();
                ...
                ObjetoDataTable = ObjLiqImpuesto.GetInfoLiquidacionForm();
            ...
            catch (Exception ex)
            {
                ...
                Ventana.Modal = true;
                string _MsgError = "Error al cargar la información del cliente. Motivo: " + ex.ToString();
        ...
        private DataSet FuenteDatos
        {
            get
            {
                ...
                else
                {
                    ...
                    ConjuntoDatos = GetInfoLiquidacion();
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtLiquidacionForm";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
