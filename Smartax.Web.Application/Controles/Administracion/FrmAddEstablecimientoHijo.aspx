<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmAddEstablecimientoHijo.aspx.cs" Inherits="Smartax.Web.Application.Controles.Administracion.Clientes.FrmAddEstablecimientoHijo" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" bgcolor="#999999">
                                <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRO DE OFICINAS HIJAS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <telerik:GridBoundColumn DataField="nombre_departamento" HeaderText="Departamento"
                                            ...
                                            <telerik:GridCheckBoxColumn DataField="inscrito_rit" HeaderText="Inscrito Rit"
                                                UniqueName="inscrito_rit">
                                            </telerik:GridCheckBoxColumn>

                                            <telerik:GridBoundColumn DataField="numero_placa_municipal" HeaderText="No. Placa Municipal"
                                                UniqueName="numero_placa_municipal" MaxLength="20" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
