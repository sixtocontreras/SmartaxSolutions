<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadEstablecimientos.aspx.cs" Inherits="Smartax.Web.Application.Controles.Administracion.Clientes.FrmLoadEstablecimientos" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="15pt" Text="REALIZAR CARGUE MASIVO DE ESTABLECIMIENTOS" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                        ...
                        <tr>
                            <td align="center" colspan="4">
                                <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" GridLines="None" OnNeedDataSource="RadGrid1_NeedDataSource" OnPageIndexChanged="RadGrid1_PageIndexChanged" PageSize="10">
                                    <MasterTableView DataKeyNames="id_establecimiento" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="id_establecimiento" EmptyDataText="" HeaderText="Id" ReadOnly="True" UniqueName="id_establecimiento">
                                            ...
                                            <telerik:GridBoundColumn DataField="Direccion" HeaderText="Direccion" UniqueName="Direccion" Visible="false">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="Telefono" HeaderText="Teléfono" UniqueName="Telefono">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="InscritoRit" HeaderText="Inscrito Rit" UniqueName="InscritoRit">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="NoEstablecimientos" HeaderText="No Establecimientos" UniqueName="NoEstablecimientos">
                                            </telerik:GridBoundColumn>
                                        </Columns>
                                    </MasterTableView>
                                </telerik:RadGrid>
