<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadActEconomicasOfic.aspx.cs" Inherits="Smartax.Web.Application.Controles.Administracion.Clientes.FrmLoadActEconomicasOfic" %>
    ...
    <form id="form2" runat="server">
        ...
        <div>
            <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" EnableAJAX="False" Width="100%">
                <asp:Panel ID="Panel2" runat="server" DefaultButton="BtnCargar" Width="100%">
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="15pt" Text="REALIZAR CARGUE MASIVO DE ACTIVIDADES ECONOMICAS POR OFICINAS" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                    ...
                                    <MasterTableView DataKeyNames="id_registro" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="id_registro" EmptyDataText="" HeaderText="Id" ReadOnly="True" 
                                                UniqueName="id_establecimiento" FilterControlWidth="40px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="codigo_oficina" HeaderText="Código" 
                                                UniqueName="codigo_oficina" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="tipo_calculo" HeaderText="Tipo Calculo" 
                                                UniqueName="tipo_calculo" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
