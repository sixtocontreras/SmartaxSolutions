<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmActividadEconomica.aspx.cs" Inherits="Smartax.Web.Application.Controles.Administracion.Clientes.FrmActividadEconomica" %>
                ...
                <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                    <tr>
                        <td align="center" bgcolor="#999999">
                            <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR ACTIVIDADES ECONOMICAS DEL CLIENTE" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                                ...
                                <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idcliente_act_economica" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                    <EditFormSettings CaptionDataField="idcliente_act_economica"
                                    ...
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="idcliente_act_economica" EmptyDataText="" FilterControlWidth="40px"
                                            HeaderText="Id" ReadOnly="True" UniqueName="idcliente_act_economica">
                                        ...
                                        <telerik:GridBoundColumn DataField="codigo_agrupacion" HeaderText="Cód. Agrupaciín"
                                            UniqueName="codigo_agrupacion" MaxLength="4">
                                        </telerik:GridBoundColumn>
