...
{
    public partial class FrmLiquidacionOficina : System.Web.UI.Page
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al listar las liquidaciones de las Oficinas. Motivo: " + ex.ToString();
        ...
        protected void LstMeses()
        {
            try
            {
                ...
                this.CmbMes.DataSource = ObjLista.GetMeses();
                this.CmbMes.DataValueField = "id_mes";
                this.CmbMes.DataTextField = "nombre_mes";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!(this.Page.IsPostBack))
            {
                ...
                this.LblMesEf.Text = this.ViewState["MesEf"].ToString().Trim();
