<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmEjecProvision.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Provision.FrmEjecProvision" %>
                            ...
                            <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                                <tr>
                                    <td colspan="4" align="center" bgcolor="#999999">
                                        <asp:Label ID="LblTitulo" runat="server" CssClass="FormLabels" Font-Bold="True" Font-Size="16pt" ForeColor="White">EJECUTAR PROVISIÓN</asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <telerik:RadNumericTextBox ID="TxtVigencia" runat="server" EmptyMessage="Vigencia" Font-Bold="False" Font-Size="15pt" Height="30px" MaxLength="10" TabIndex="2" Width="100px" AutoPostBack="True" OnTextChanged="TxtVigencia_TextChanged">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:Button ID="BtnEjecutar" runat="server" Font-Bold="True" Font-Size="14pt" Text="Ejecutar" ToolTip="Click para ejecutar el proceso de provisión" Width="120px" OnClick="BtnEjecutar_Click" ValidationGroup="ValidarDatos" />
                                        &nbsp;<asp:Button ID="BtnSalir" runat="server" Font-Bold="True" Font-Size="14pt" OnClientClick="window.close()" Text="Salir" Width="120px" ToolTip="Salir" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
