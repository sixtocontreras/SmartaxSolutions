...
{
    public partial class CtrlConceptosProv : UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);
        RadWindow Ventana = new RadWindow();

        ConceptosProv ObjConceptosProv = new ConceptosProv();
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ...
                ObjetoDataTable = ObjConceptosProv.GetAllConceptosProv();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_conceptos_prov_ica"] };
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtConceptosProv";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "CONCEPTOS_PROVISION_ICA";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("cod_concepto");
                    ...
                    //--
                    GridTextBoxColumnEditor editor3 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("cod_concepto");
                    ...
                    //--
                    GridTextBoxColumnEditor editor4 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("desc_concepto");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtConceptosProv"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_conceptos_prov_ica"] };
            DataRow[] TodosValores = TablaDatos.Select("", "id_conceptos_prov_ica", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjConceptosProv.CodConcepto = NuevaFila["cod_concepto"].ToString().Trim().ToUpper();
                    ObjConceptosProv.Descripcion = NuevaFila["desc_concepto"].ToString().Trim().ToUpper();
                    ...
                    _log.Warn("REQUEST INSERT CONCEPTOS PROVISION => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjConceptosProv.AddUpConceptoProv(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["id_conceptos_prov_ica"] = _IdRegistro;
                        ...
                        NuevaFila["cod_concepto"] = NuevaFila["cod_concepto"].ToString().Trim().ToUpper();
                        NuevaFila["desc_concepto"] = NuevaFila["desc_concepto"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtConceptosProv"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "CONCEPTOS_PROVISION_ICA";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtConceptosProv"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_conceptos_prov_ica"] };
            DataRow[] changedRows = TablaDatos.Select("id_conceptos_prov_ica = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["id_conceptos_prov_ica"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["id_conceptos_prov_ica"].ToString().Trim());
            ...
            try
            {
                ...
                ObjConceptosProv.CodConcepto = changedRows[0]["cod_concepto"].ToString().Trim().ToUpper();
                ObjConceptosProv.Descripcion = changedRows[0]["desc_concepto"].ToString().Trim().ToUpper();
                ...
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjConceptosProv);
                _log.Warn("REQUEST UPDATE CONCEPTOS PROVISION => " + jsonRequest);
                ...
                if (ObjConceptosProv.AddUpConceptoProv(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    ...
                    changedRows[0]["cod_concepto"] = changedRows[0]["cod_concepto"].ToString().Trim().ToUpper();
                    changedRows[0]["desc_concepto"] = changedRows[0]["desc_concepto"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtConceptosProv"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtConceptosProv"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjConceptosProv.IdCliente = changedRows[0]["id_cliente"] != null ? changedRows[0]["id_cliente"].ToString().Trim() : null;
                ObjConceptosProv.Vigencia = Int32.Parse(changedRows[0]["vigencia"].ToString().Trim());
                ObjConceptosProv.CodConcepto = changedRows[0]["cod_concepto"].ToString().Trim();
                ObjConceptosProv.Descripcion = changedRows[0]["desc_concepto"].ToString().Trim();
                ObjConceptosProv.IdEstado = changedRows[0]["id_estado"].ToString().Trim();
                ObjConceptosProv.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjConceptosProv.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                ObjConceptosProv.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ...
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjConceptosProv);
                _log.Warn("REQUEST DELETE CONCEPTOS PROVISION => " + jsonRequest);

                if (ObjConceptosProv.AddUpConceptoProv(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtConceptosProv"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtConceptosProv"].AcceptChanges();
