...
{
    public partial class CtrlConfClienteProv : UserControl
    {

        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);
        RadWindow Ventana = new RadWindow();

        ConfClienteProv ObjConfClienteProv = new ConfClienteProv();
        NivelProv ObjNovelProv = new NivelProv();
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjConfClienteProv.TipoConsulta = 1;
                ObjConfClienteProv.IdEstado = null;
                ObjConfClienteProv.IdCliente = this.Session["IdCliente"] != null ? this.Session["IdCliente"].ToString().Trim() : null;
                ObjConfClienteProv.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los tipos de regimen
                ObjetoDataTable = ObjConfClienteProv.GetAllConfClientProv();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_conf_cliente_prov_ica"] };
                ...
                //Mostrar los Niveles
                ObjetoDataTable = new DataTable();
                ObjNovelProv.TipoConsulta = 2;
                ObjNovelProv.MostrarSeleccione = "NO";
                ObjNovelProv.IdEmpresa = Convert.ToInt32(Session["IdEmpresa"].ToString().Trim());
                ObjNovelProv.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                ObjetoDataTable = ObjNovelProv.GetNivelProv();
                ObjetoDataSet.Tables.Add(ObjetoDataTable);
            }
            catch (Exception ex)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Configuración cliente provisión";
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtConfClienteProv";
                ...
                columna.DataField = "id_nivel_prov_ica";
                columna.ListTextField = "desc_nivel";
                columna.ListValueField = "id_nivel_prov_ica";
                columna.ListDataMember = "DtNivelProv";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "CONF_CLIENTE_PROV";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("desc_comp");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtConfClienteProv"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_conf_cliente_prov_ica"] };
            DataRow[] TodosValores = TablaDatos.Select("", "id_conf_cliente_prov_ica", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    string CmbNivel = (editedItem["id_nivel_prov_ica"].Controls[0] as RadComboBox).SelectedItem.Text;

                    ObjConfClienteProv.IdConfClienteProv = null;
                    ObjConfClienteProv.IdCliente = NuevaFila["id_cliente"] != null ? NuevaFila["id_cliente"].ToString().Trim() : null;
                    ObjConfClienteProv.Vigencia = Int32.Parse(NuevaFila["vigencia"].ToString().Trim());
                    ObjConfClienteProv.Descripcion = NuevaFila["desc_comp"].ToString().Trim().ToUpper();
                    ObjConfClienteProv.Nivel = NuevaFila["id_nivel_prov_ica"].ToString().Trim();
                    ObjConfClienteProv.IdEstado = NuevaFila["id_estado"].ToString().Trim();
                    ObjConfClienteProv.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjConfClienteProv.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                    ObjConfClienteProv.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                    ObjConfClienteProv.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjConfClienteProv.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjConfClienteProv);
                    _log.Warn("REQUEST INSERT CONF CLIENTE PROV => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjConfClienteProv.AddUpConfClientProv(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["id_conf_cliente_prov_ica"] = _IdRegistro;
                        ...
                        NuevaFila["desc_comp"] = NuevaFila["desc_comp"].ToString().Trim().ToUpper();
                        NuevaFila["nivel"] = NuevaFila["id_nivel_prov_ica"].ToString().Trim().ToUpper();
                        NuevaFila["desc_nivel"] = CmbNivel.ToString().Trim();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtConfClienteProv"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "CONF_CLIENTE_PROV";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtConfClienteProv"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_conf_cliente_prov_ica"] };
            DataRow[] changedRows = TablaDatos.Select("id_conf_cliente_prov_ica = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["id_conf_cliente_prov_ica"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["id_conf_cliente_prov_ica"].ToString().Trim());
            ...
            try
            {
                ...
                ObjConfClienteProv.IdConfClienteProv = _IdRegistro;
                ObjConfClienteProv.IdCliente = changedRows[0]["id_cliente"] != null ? changedRows[0]["id_cliente"].ToString().Trim() : null;
                ObjConfClienteProv.Vigencia = Int32.Parse(changedRows[0]["vigencia"].ToString().Trim());
                ObjConfClienteProv.Descripcion = changedRows[0]["desc_comp"].ToString().Trim().ToUpper();
                ObjConfClienteProv.Nivel = changedRows[0]["id_nivel_prov_ica"].ToString().Trim();
                ObjConfClienteProv.IdEstado = changedRows[0]["id_estado"].ToString().Trim();
                ObjConfClienteProv.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjConfClienteProv.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                ObjConfClienteProv.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjConfClienteProv.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjConfClienteProv.TipoProceso = 2;
                ...
                string _MsgError = "";
                if (ObjConfClienteProv.AddUpConfClientProv(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    ...
                    changedRows[0]["desc_comp"] = changedRows[0]["desc_comp"].ToString().Trim().ToUpper();
                    changedRows[0]["nivel"] = CmbNivel.ToString().Trim().ToUpper();
                    changedRows[0]["desc_nivel"] = CmbNivel.ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtConfClienteProv"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtConfClienteProv"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjConfClienteProv.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjConfClienteProv.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjConfClienteProv.TipoProceso = 3;
                ...
                if (ObjConfClienteProv.AddUpConfClientProv(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtConfClienteProv"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtConfClienteProv"].AcceptChanges();
