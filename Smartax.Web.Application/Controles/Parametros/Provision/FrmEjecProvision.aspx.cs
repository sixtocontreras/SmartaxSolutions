...
{
    public partial class FrmEjecProvision : System.Web.UI.Page
    {
        ...
        EjecutarProv ObjEjecutarProv = new EjecutarProv();
        #endregion
        ...
        protected void BtnEjecutar_Click(object sender, EventArgs e)
        {
            try
            {
                ObjEjecutarProv.IdCliente = this.CmbCliente.SelectedValue.Trim();
                ObjEjecutarProv.Vigencia = Int32.Parse(this.TxtVigencia.Text.Trim());
                ObjEjecutarProv.PeriodoImpuesto = Int32.Parse(this.TxtPeriodoImpuesto.Text.Trim());
                //-DATOS DEL USUARIO
                ObjEjecutarProv.FormularioImpuesto = Int32.Parse(ConfigurationManager.AppSettings["ID_FORMULARIO_IMPUESTO"].ToString());
                ObjEjecutarProv.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjEjecutarProv.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();

                int _IdRegistro = 0;
                string _MsgError = "";
                if (ObjEjecutarProv.ExecProv(ref _IdRegistro, ref _MsgError))
                {
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgMensaje = "Señor usuario. Ocurrio un Error al ejecutar la provisión. Motivo: " + ex.ToString();
                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgMensaje;
                Ventana.ID = "RadWindow2";
                Ventana.VisibleOnPageLoad = true;
                Ventana.Visible = true;
