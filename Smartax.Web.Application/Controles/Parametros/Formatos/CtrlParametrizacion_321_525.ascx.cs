...
{
    public partial class CtrlParametrizacion_321_525 : System.Web.UI.UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);
        RadWindow Ventana = new RadWindow();

        ConfParam321_525 ObjConfInf = new ConfParam321_525();
        ConfInfoEntidad ObjEntidad = new ConfInfoEntidad();
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ...
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_param_f321_f525"] };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Parametrización F-321 525";
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "Param321525";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "CONF_PARAM_321_525";
                ...
                else if (e.CommandName == "BtnConfiguracion")
                {
                    ...
                    int _IdColumna = Convert.ToInt32(item.GetDataKeyValue("id_param_f321_f525").ToString().Trim());
                    int idCliente = Convert.ToInt32(FuenteDatos.Tables["Param321525"].Select($"id_param_f321_f525 = {_IdColumna}")[0][11]);
                    string _NombreColumna = item.Cells[6].Text.Trim();
                    ...
                    string _PathUrl = HttpContext.Current.Request.ServerVariables["PATH_INFO"].ToString().Trim();
                    Ventana.NavigateUrl = "/Controles/Administracion/Formatos/FrmConfiguracionCuentas.aspx?IdColumna=" + _IdColumna + $"&IdCliente={idCliente}&PathUrl=" + _PathUrl;
                    ...
                    Ventana.KeepInScreenBounds = true;
                    Ventana.Title = "Configurar Columna: " + _NombreColumna;
                    Ventana.VisibleStatusbar = false;
                    Ventana.Behaviors = WindowBehaviors.Close;
                    this.RadWindowManager1.Windows.Add(Ventana);
                    this.RadWindowManager1 = null;
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    //--
                    GridTextBoxColumnEditor editor2 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("base_resultante");
                    TableCell cell1 = (TableCell)editor2.TextBoxControl.Parent;
                    ...
                    GridNumericColumnEditor editor = (GridNumericColumnEditor)item.EditManager.GetColumnEditor("columna_321");
                    ...
                    GridTextBoxColumnEditor editor1 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("subcuenta_f525");
                    ...
                    GridTextBoxColumnEditor editor3 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("nombre_cuenta_f525");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            string _MsgError = "";
            var dt = ObjEntidad.GetAllConfEntidad();
            var columns = 0;

            if ((editedItem["base_resultante"].Controls[0] as TextBox).Text != "S" && (editedItem["base_resultante"].Controls[0] as TextBox).Text != "N")
            {
                _MsgError = "El campo base resultante solo acepta 'S' ó 'N'";
                #region MOSTRAR MENSAJE DE USUARIO
                //Mostramos el mensaje porque se produjo un error con la Trx.
                this.RadWindowManager1.ReloadOnShow = true;
                this.RadWindowManager1.DestroyOnClose = true;
            ...
            {
                if (int.Parse(item["id_cliente"].ToString()) == idCmbCliente)
                    columns = int.Parse(item["numero_columnas_f321"].ToString());
            }
            if (int.Parse((editedItem["columna_321"].Controls[0] as RadNumericTextBox).Text) > columns)
            {
                _MsgError = $"El numero maximo de la columna es {columns}.";
                #region MOSTRAR MENSAJE DE USUARIO
                //Mostramos el mensaje porque se produjo un error con la Trx.
                this.RadWindowManager1.ReloadOnShow = true;
                this.RadWindowManager1.DestroyOnClose = true;
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["Param321525"]; ;
            var ct = TablaDatos.Select($"id_cliente = {idCmbCliente} AND columna_321 = {(editedItem["columna_321"].Controls[0] as RadNumericTextBox).Text}").Count();
            if (ct > 0)
            {
                _MsgError = $"Ya existe una columna con este numero.";
                #region MOSTRAR MENSAJE DE USUARIO
                //Mostramos el mensaje porque se produjo un error con la Trx.
                this.RadWindowManager1.ReloadOnShow = true;
                this.RadWindowManager1.DestroyOnClose = true;
            ...
            var sr = TablaDatos.Select($"id_cliente = {idCmbCliente}").Count();
            if (sr >= columns)
            {
                _MsgError = "El cliente ya tiene el maximo de columnas parametrizadas.";
                #region MOSTRAR MENSAJE DE USUARIO
                //Mostramos el mensaje porque se produjo un error con la Trx.
                this.RadWindowManager1.ReloadOnShow = true;
                this.RadWindowManager1.DestroyOnClose = true;
            ...
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_param_f321_f525"] };
            DataRow[] TodosValores = TablaDatos.Select("", "id_param_f321_f525", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    _log.Warn("REQUEST INSERT CONF_PARAM_321_525 => " + jsonRequest);

                    int _IdRegistro = 0;
                    if (ObjConfInf.AddConfEntidad(NuevaFila, Int32.Parse(Session["IdUsuario"].ToString().Trim()), ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["columna_321"] = NuevaFila["columna_321"].ToString().Trim().ToUpper();
                        NuevaFila["etiqueta"] = NuevaFila["etiqueta"].ToString().Trim().ToUpper();
                        NuevaFila["base_resultante"] = NuevaFila["base_resultante"].ToString().Trim().ToUpper();
                        NuevaFila["subcuenta_f525"] = NuevaFila["subcuenta_f525"].ToString().Trim().ToUpper();
                        NuevaFila["nombre_cuenta_f525"] = NuevaFila["nombre_cuenta_f525"].ToString().Trim().ToUpper();
                        ...
                        NuevaFila["id_param_f321_f525"] = _IdRegistro;
                        this.FuenteDatos.Tables["Param321525"].Rows.Add(NuevaFila);
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["Param321525"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_param_f321_f525"] };
            DataRow[] changedRows = TablaDatos.Select("id_param_f321_f525 = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["id_param_f321_f525"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["id_param_f321_f525"].ToString().Trim());
            ...
            try
            {
                ...
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjConfInf);
                _log.Warn("REQUEST UPDATE CONF_PARAM_321_525 => " + jsonRequest);

                string _MsgError = "";
                if (ObjConfInf.UpConfEntidad(changedRows[0], Int32.Parse(Session["IdUsuario"].ToString().Trim()), ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["columna_321"] = changedRows[0]["columna_321"].ToString().Trim().ToUpper();
                    changedRows[0]["etiqueta"] = changedRows[0]["etiqueta"].ToString().Trim().ToUpper();
                    changedRows[0]["base_resultante"] = changedRows[0]["base_resultante"].ToString().Trim().ToUpper();
                    changedRows[0]["subcuenta_f525"] = changedRows[0]["subcuenta_f525"].ToString().Trim().ToUpper();
                    changedRows[0]["nombre_cuenta_f525"] = changedRows[0]["nombre_cuenta_f525"].ToString().Trim().ToUpper();
                    changedRows[0]["nombre_cliente"] = CmbCliente.ToString().Trim().ToUpper();
                    changedRows[0]["id_cliente"] = idCmbCliente;
                    this.FuenteDatos.Tables["Param321525"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["Param321525"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjConfInf);
                _log.Warn("REQUEST DELETE CONF_PARAM_321_525 => " + jsonRequest);

                if (ObjConfInf.dltConfEntidad(Int32.Parse(Session["IdUsuario"].ToString().Trim()), ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["Param321525"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["Param321525"].AcceptChanges();
