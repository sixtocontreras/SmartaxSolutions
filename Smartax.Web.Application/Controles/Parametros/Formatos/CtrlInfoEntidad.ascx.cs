...
{
    public partial class CtrlInfoEntidad : System.Web.UI.UserControl
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);
        RadWindow Ventana = new RadWindow();

        ConfInfoEntidad ObjConfInf = new ConfInfoEntidad();
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ...
                ObjetoDataTable = ObjConfInf.GetAllConfEntidad();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_informacion_cliente_sfc"] };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Configuración información Entidad";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "CONF_INFORMACION_ENTIDAD";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("tipo_entidad");
                    ...
                    //--
                    GridTextBoxColumnEditor editor2 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("codigo_entidad");
                    ...
                    GridTextBoxColumnEditor editor3 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("nombre_entidad");
                    cell1 = (TableCell)editor3.TextBoxControl.Parent;
                    validator = new RequiredFieldValidator();
                    ...
                    GridTextBoxColumnEditor editor4 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("palabra_clave");
                    cell1 = (TableCell)editor4.TextBoxControl.Parent;
                    validator = new RequiredFieldValidator();
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_informacion_cliente_sfc"] };
            DataRow[] TodosValores = TablaDatos.Select("", "id_informacion_cliente_sfc", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    //ObjConfInf.IdConfClienteProv = null;
                    //ObjConfInf.IdCliente = NuevaFila["id_cliente"] != null ? NuevaFila["id_cliente"].ToString().Trim() : null;
                    //ObjConfInf.Vigencia = Int32.Parse(NuevaFila["vigencia"].ToString().Trim());
                    //ObjConfInf.Descripcion = NuevaFila["desc_comp"].ToString().Trim().ToUpper();
                    //ObjConfInf.Nivel = NuevaFila["id_nivel_prov_ica"].ToString().Trim();
                    //ObjConfInf.IdEstado = NuevaFila["id_estado"].ToString().Trim();
                    //ObjConfInf.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    //ObjConfInf.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                    //ObjConfInf.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                    //ObjConfInf.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    //ObjConfInf.TipoProceso = 1;
                    ...
                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjConfInf.AddConfEntidad(NuevaFila, Int32.Parse(Session["IdUsuario"].ToString().Trim()), ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["tipo_entidad"] = NuevaFila["tipo_entidad"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_entidad"] = NuevaFila["codigo_entidad"].ToString().Trim().ToUpper();
                        NuevaFila["nombre_entidad"] = NuevaFila["nombre_entidad"].ToString().Trim().ToUpper();
                        NuevaFila["palabra_clave"] = NuevaFila["palabra_clave"].ToString().Trim().ToUpper();
                        NuevaFila["area_informacion"] = NuevaFila["area_informacion"].ToString().Trim().ToUpper();
                        NuevaFila["tipo_informe"] = NuevaFila["tipo_informe"].ToString().Trim().ToUpper();
                        ...
                        NuevaFila["tipo_informacion"] = NuevaFila["tipo_informacion"].ToString().Trim().ToUpper();
                        NuevaFila["tipo_fideicomiso_fondo"] = NuevaFila["tipo_fideicomiso_fondo"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_fideicomiso_fondo"] = NuevaFila["codigo_fideicomiso_fondo"].ToString().Trim().ToUpper();
                        NuevaFila["numero_columnas_f321"] = NuevaFila["numero_columnas_f321"].ToString().Trim().ToUpper();
                        NuevaFila["unidad_captura_tn_f321"] = NuevaFila["unidad_captura_tn_f321"].ToString().Trim().ToUpper();
                        NuevaFila["unidad_captura_f525"] = NuevaFila["unidad_captura_f525"].ToString().Trim().ToUpper();
                        ...
                        NuevaFila["id_informacion_cliente_sfc"] = _IdRegistro;
                        ...
                        ObjAuditoria.ModuloApp = "CONF_INFORMACION_ENTIDAD";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_informacion_cliente_sfc"] };
            DataRow[] changedRows = TablaDatos.Select("id_informacion_cliente_sfc = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["id_informacion_cliente_sfc"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["id_informacion_cliente_sfc"].ToString().Trim());
            ...
            try
            {
                ...
                string _MsgError = "";
                if (ObjConfInf.UpConfEntidad(changedRows[0], Int32.Parse(Session["IdUsuario"].ToString().Trim()), ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["tipo_entidad"] = changedRows[0]["tipo_entidad"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_entidad"] = changedRows[0]["codigo_entidad"].ToString().Trim().ToUpper();
                    changedRows[0]["nombre_entidad"] = changedRows[0]["nombre_entidad"].ToString().Trim().ToUpper();
                    changedRows[0]["palabra_clave"] = changedRows[0]["palabra_clave"].ToString().Trim().ToUpper();
                    changedRows[0]["area_informacion"] = changedRows[0]["area_informacion"].ToString().Trim().ToUpper();
                    changedRows[0]["tipo_informe"] = changedRows[0]["tipo_informe"].ToString().Trim().ToUpper();
                    ...
                    changedRows[0]["tipo_informacion"] = changedRows[0]["tipo_informacion"].ToString().Trim().ToUpper();
                    changedRows[0]["tipo_fideicomiso_fondo"] = changedRows[0]["tipo_fideicomiso_fondo"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_fideicomiso_fondo"] = changedRows[0]["codigo_fideicomiso_fondo"].ToString().Trim().ToUpper();
                    changedRows[0]["numero_columnas_f321"] = changedRows[0]["numero_columnas_f321"].ToString().Trim().ToUpper();
                    changedRows[0]["unidad_captura_tn_f321"] = changedRows[0]["unidad_captura_tn_f321"].ToString().Trim().ToUpper();
                    changedRows[0]["unidad_captura_f525"] = changedRows[0]["unidad_captura_f525"].ToString().Trim().ToUpper();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (ObjConfInf.dltConfEntidad(Int32.Parse(Session["IdUsuario"].ToString().Trim()), ref _IdRegistro, ref _MsgError))
                {
