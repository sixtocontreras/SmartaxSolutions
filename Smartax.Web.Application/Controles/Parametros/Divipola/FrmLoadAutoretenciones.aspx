<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadAutoretenciones.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Divipola.FrmLoadAutoretenciones" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="13pt" Text="REALIZAR CARGUE MASIVO DE AUTORETENCIONES" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                    ...
                                    <MasterTableView DataKeyNames="id_registro" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="municipio" HeaderText="Municipio"
                                                UniqueName="municipio" FilterControlWidth="120px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="numero_renglon" HeaderText="No. Renglon" 
                                                UniqueName="numero_renglon" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="valor_autoretencion" HeaderText="Valor" 
                                                UniqueName="valor_autoretencion" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
