<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadActEconomica.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Divipola.FrmLoadActEconomica" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="13pt" Text="REALIZAR CARGUE MASIVO DE ACTIVIDADES ECONOMICAS" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                    ...
                                    <MasterTableView DataKeyNames="id_registro" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="ano_gravable" HeaderText="Año Gravable" 
                                                UniqueName="ano_gravable" FilterControlWidth="50px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="tipo_actividad" HeaderText="Fecha Limite" 
                                                UniqueName="tipo_actividad" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="valor_ley" HeaderText="Valor Ley" 
                                                UniqueName="valor_ley" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="valor_municipio" HeaderText="Valor Munic." 
                                                UniqueName="valor_municipio" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
