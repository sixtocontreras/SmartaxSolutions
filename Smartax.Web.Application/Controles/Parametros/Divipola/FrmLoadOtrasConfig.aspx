<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadOtrasConfig.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Divipola.FrmLoadOtrasConfig" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="13pt" Text="REALIZAR CARGUE MASIVO DE OTRAS CONFIGURACIONES" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                    ...
                                    <MasterTableView DataKeyNames="id_registro" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="id_registro" EmptyDataText="" HeaderText="Id" 
                                                UniqueName="id_registro" ReadOnly="True" FilterControlWidth="40px">
                                            ...
                                            <telerik:GridBoundColumn DataField="unidad_medida" HeaderText="Unidad Medida" 
                                                UniqueName="unidad_medida" FilterControlWidth="70px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="anio_gravable" HeaderText="Año Gravable" 
                                                UniqueName="anio_gravable" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="anio_fiscal" HeaderText="Año Fiscal" 
                                                UniqueName="anio_fiscal" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="valor_unidad" HeaderText="Valor Unid." 
                                                UniqueName="valor_unidad" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="cantidad_periodos" HeaderText="Cant. Periodos" 
                                                UniqueName="cantidad_periodos" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="para_calcular" HeaderText="Calcular" 
                                                UniqueName="para_calcular" FilterControlWidth="50px">
                                            </telerik:GridBoundColumn>
