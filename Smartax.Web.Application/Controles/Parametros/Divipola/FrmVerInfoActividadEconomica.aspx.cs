...
{
    public partial class FrmVerInfoActividadEconomica : System.Web.UI.Page
    {
        ...
        public DataSet GetInfoMunicipio()
        {
            DataSet ObjetoDataSet = new DataSet();
            DataTable ObjetoDataTable = new DataTable();
            try
            {
                ObjMunActividad.TipoConsulta = 2;
                ObjMunActividad.IdMunicipio = this.ViewState["IdMunicipio"].ToString().Trim();
                ObjMunActividad.IdMunActividadEconomica = this.ViewState["IdMunActEconomica"].ToString().Trim();
            ...
            catch (Exception ex)
            {
                ...
                Ventana.Modal = true;
                string _MsgError = "Error al cargar la información de la entidad. Motivo: " + ex.ToString();
        ...
        private DataSet FuenteDatos
        {
            get
            {
                ...
                else
                {
                    ...
                    ConjuntoDatos = GetInfoMunicipio();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.ViewState["IdMunActEconomica"] = Request.QueryString["IdMunActEconomica"].ToString().Trim();
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtMunActividadEconomica";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
