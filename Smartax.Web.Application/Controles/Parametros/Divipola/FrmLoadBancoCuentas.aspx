<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadBancoCuentas.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Divipola.FrmLoadBancoCuentas" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="13pt" Text="REALIZAR CARGUE MASIVO DE BANCOS Y CUENTAS" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                            ...
                            <td align="center" colspan="4">
                                <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" GridLines="None" OnNeedDataSource="RadGrid1_NeedDataSource" OnPageIndexChanged="RadGrid1_PageIndexChanged" PageSize="10">
                                    <MasterTableView DataKeyNames="id_registro" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="id_registro" EmptyDataText="" HeaderText="Id" ReadOnly="True" 
                                                UniqueName="id_registro" FilterControlWidth="40px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="municipio" HeaderText="Municipio"
                                                UniqueName="municipio" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="banco" HeaderText="Banco" 
                                                UniqueName="banco" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="tipo_cuenta" HeaderText="Tipo Cuenta" 
                                                UniqueName="tipo_cuenta" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="medio_pago" HeaderText="Medio Pago" 
                                                UniqueName="medio_pago" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="numero_cuenta" HeaderText="No. Cuenta" 
                                                UniqueName="numero_cuenta" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="version_registro" HeaderText="Version Registro" 
                                                UniqueName="version_registro" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
