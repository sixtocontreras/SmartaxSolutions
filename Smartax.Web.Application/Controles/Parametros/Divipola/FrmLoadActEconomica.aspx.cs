...
{
    public partial class FrmLoadActEconomica : System.Web.UI.Page
    {
        ...
        private DataTable GetTablaDatos()
        {
            ...
            try
            {
                ...
                {
                    dtDatos = DtActEconomica.Copy();
                }
                else
                {
                    //Creamos el DataTable donde se almacenaran las Facturas a Pagar.
                    DtActEconomica = new DataTable();
                    DtActEconomica.TableName = "DtActEconomica";
                    DtActEconomica.Columns.Add("id_registro", typeof(Int32));
                    DtActEconomica.PrimaryKey = new DataColumn[] { DtActEconomica.Columns["id_registro"] };
                    DtActEconomica.Columns.Add("id_municipio");
                    DtActEconomica.Columns.Add("municipio");
                    DtActEconomica.Columns.Add("id_formulario");
                    DtActEconomica.Columns.Add("formulario");
                    DtActEconomica.Columns.Add("ano_gravable");
                    DtActEconomica.Columns.Add("idtipo_actividad");
                    DtActEconomica.Columns.Add("tipo_actividad");
                    DtActEconomica.Columns.Add("cod_agrupacion");
                    DtActEconomica.Columns.Add("cod_actividad");
                    DtActEconomica.Columns.Add("descripcion");
                    DtActEconomica.Columns.Add("idtipo_tarifa");
                    DtActEconomica.Columns.Add("valor_ley");
                    DtActEconomica.Columns.Add("valor_municipio");
                    DtActEconomica.Columns.Add("num_acuerdo");
                    DtActEconomica.Columns.Add("num_articulo");
                    DtActEconomica.Columns.Add("id_estado");
                    DtActEconomica.Columns.Add("estado");
                    dtDatos = DtActEconomica.Copy();
                }

                this.ViewState["DtActEconomica"] = dtDatos;
            }
            catch (Exception ex)
            {
                dtDatos = null;
                    ...
                    if (dtEtl != null)
                    {
                        if (dtEtl.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow rowItem in dtEtl.Rows)
                            {
                                ...
                                DataRow Fila = null;
                                Fila = DtActEconomica.NewRow();
                                //--
                                Fila["id_registro"] = DtActEconomica.Rows.Count + 1;
                                Fila["id_municipio"] = rowItem["Id Municipio"].ToString().Trim();
                                Fila["municipio"] = ObjUtils.GetLimpiarCadena(rowItem["Municipio"].ToString().Trim().ToUpper());
                                Fila["id_formulario"] = rowItem["Id Impuesto"].ToString().Trim();
                                Fila["formulario"] = rowItem["Impuesto"].ToString().Trim();
                                Fila["ano_gravable"] = rowItem["Anio Gravable"].ToString().Trim();
                                Fila["idtipo_actividad"] = rowItem["Id Tipo Actividad"].ToString().Trim();
                                Fila["tipo_actividad"] = rowItem["Tipo Actividad"].ToString().Trim();
                                Fila["cod_agrupacion"] = rowItem["Cod. Agrupacion"].ToString().Trim();
                                Fila["cod_actividad"] = rowItem["Cod. Actividad"].ToString().Trim();
                                Fila["descripcion"] = ObjUtils.GetLimpiarCadena(rowItem["Descripcion"].ToString().Trim().ToUpper());
                                Fila["idtipo_tarifa"] = rowItem["Id Tipo Tarifa"].ToString().Trim();
                                Fila["valor_ley"] = rowItem["Valor Ley"].ToString().Trim();
                                Fila["valor_municipio"] = rowItem["Valor Municipio"].ToString().Trim();
                                Fila["num_acuerdo"] = ObjUtils.GetLimpiarCadena(rowItem["No. Acuerdo"].ToString().Trim().ToUpper());
                                Fila["num_articulo"] = ObjUtils.GetLimpiarCadena(rowItem["No. Articulo"].ToString().Trim().ToUpper());
                                Fila["id_estado"] = rowItem["Id Estado"].ToString().Trim().Length > 0 ? rowItem["Id Estado"].ToString().Trim() : "1";
                                Fila["estado"] = rowItem["Estado"].ToString().Trim();
                                DtActEconomica.Rows.Add(Fila);
                                #endregion
                            }
                            ...
                            if (DtActEconomica.Rows.Count > 0)
                            {
                                ...
                                RadWindow Ventana = new RadWindow();
                                Ventana.Modal = true;
                                _MsgError = "El Proceso del archivo ha sido realizado correctamente con [" + DtActEconomica.Rows.Count + "] registros.";
                                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                                Ventana.ID = "RadWindow2";
                                Ventana.VisibleOnPageLoad = true;
                                Ventana.Visible = true;
        ...
        protected void BtnProcesar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (DtActEconomica != null)
                {
                    if (DtActEconomica.Rows.Count > 0)
                    {
                        int ContadorRow = DtActEconomica.Rows.Count;
                        ...
                        foreach (DataRow rowItem in DtActEconomica.Rows)
                        {
                            ...
                            string _IdTipoActividad = rowItem["idtipo_actividad"].ToString().Trim();
                            string _CodAgrupacion = rowItem["cod_agrupacion"].ToString().Trim().Length > 0 ? rowItem["cod_agrupacion"].ToString().Trim() : "NA";
                            string _CodActividad = rowItem["cod_actividad"].ToString().Trim().Length > 0 ? rowItem["cod_actividad"].ToString().Trim() : "NA";
                            string _Descripcion = ObjUtils.GetLimpiarCadena(rowItem["descripcion"].ToString().Trim().ToUpper());
                            string _IdTipoTarifa = rowItem["idtipo_tarifa"].ToString().Trim();
                            string _ValorLey = rowItem["valor_ley"].ToString().Trim();
                            string _ValorMunicipio = rowItem["valor_municipio"].ToString().Trim();
                            string _NumAcuerdo = rowItem["num_acuerdo"].ToString().Trim().Length > 0 ? ObjUtils.GetLimpiarCadena(rowItem["num_acuerdo"].ToString().Trim().ToUpper()) : "NA";
                            string _NumArticulo = rowItem["num_articulo"].ToString().Trim().Length > 0 ? ObjUtils.GetLimpiarCadena(rowItem["num_articulo"].ToString().Trim().ToUpper()) : "NA";
                            int _IdEstado = rowItem["id_estado"].ToString().Trim().Length > 0 ? Int32.Parse(rowItem["id_estado"].ToString().Trim()) : 1;

                            //--ARMAMOS EL ARRAY DE LOS DATOS A CARGAR
                            if (_ArrayData.ToString().Trim().Length > 0)
                            {
                                _ArrayData = _ArrayData.ToString().Trim() + ", " + quote + "(" + _IdMunicipio + ", " + _IdFormulario + ", " + _AnoGravable + ", " + _IdTipoActividad + ", " + _CodAgrupacion + ", " + _CodActividad + ", " + _Descripcion + ", " + _IdTipoTarifa + ", " + _ValorLey + ", " + _ValorMunicipio + ", " + _NumAcuerdo + ", " + _NumArticulo + ", " + _IdEstado + ")" + quote;
                            }
                            else
                            {
                                _ArrayData = quote + "(" + _IdMunicipio + ", " + _IdFormulario + ", " + _AnoGravable + ", " + _IdTipoActividad + ", " + _CodAgrupacion + ", " + _CodActividad + ", " + _Descripcion + ", " + _IdTipoTarifa + ", " + _ValorLey + ", " + _ValorMunicipio + ", " + _NumAcuerdo + ", " + _NumArticulo + ", " + _IdEstado + ")" + quote;
                            }
                        ...
                        if (_ArrayData.ToString().Trim().Length > 0)
                        {
                            ObjMunActividad.ArrayData = _ArrayData.ToString().Trim();
                            int _IdRegistro = 0;
                            string _MsgError = "";
                            if (ObjMunActividad.GetLoadActEconomica(ref _IdRegistro, ref _MsgError))
                            {
                                #region MOSTRAR MENSAJE DE USUARIO
                                DtActEconomica = null;
                                this.ViewState["DtActEconomica"] = null;
