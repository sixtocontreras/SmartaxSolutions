<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadImpMunicipio.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Divipola.FrmLoadImpMunicipio" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="13pt" Text="REALIZAR CARGUE MASIVO DE IMPUESTOS DE MUNICIPIOS" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
