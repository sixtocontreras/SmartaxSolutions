...
{
    public partial class FrmMunicipioImpuestos : System.Web.UI.Page
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjMunImpuesto.TipoConsulta = 1;
                ObjMunImpuesto.IdMunImpuesto = null;
                ...
                ObjetoDataTable = ObjMunImpuesto.GetAllMunImpuesto();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idmun_impuesto"] };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!(this.Page.IsPostBack))
            {
                ...
                {
                    this.LbTitulo.Text = "INFORMACIÓN DE IMPUESTOS DEL MUNICIPIO";
                    this.RadGrid1.MasterTableView.CommandItemDisplay = 0;
                    this.RadGrid1.Columns[RadGrid1.Columns.Count - 1].Visible = false;
                    this.RadGrid1.Columns[RadGrid1.Columns.Count - 2].Visible = false;
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                this.RadGrid1.DataMember = "DtMunImpuesto";
            }
            catch (Exception ex)
            {
                #region MOSTRAR MENSAJE DE USUARIO
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnAddImpuesto")
                {
                    ...
                    int _IdMunImpuesto = 0;
                    string _TipoProceso = "INSERT";
                    string _PathUrl = HttpContext.Current.Request.ServerVariables["PATH_INFO"].ToString().Trim();
                    Ventana.NavigateUrl = "/Controles/Parametros/Divipola/FrmAddMunicipioImpuestos.aspx?IdMunImpuesto=" + _IdMunImpuesto + "&IdMunicipio=" + this.ViewState["IdMunicipio"].ToString().Trim() + "&TipoProceso=" + _TipoProceso + "&PathUrl=" + _PathUrl;
                    ...
                    Ventana.KeepInScreenBounds = true;
                    Ventana.Title = "Agregar nuevo impuesto....";
                    Ventana.VisibleStatusbar = false;
                    Ventana.Behaviors = WindowBehaviors.Close;
                    this.RadWindowManager1.Windows.Add(Ventana);
                    this.RadWindowManager1 = null;
                ...
                else if (e.CommandName == "BtnEditar")
                {
                    ...
                    int _IdMunImpuesto = Convert.ToInt32(item.GetDataKeyValue("idmun_impuesto").ToString().Trim());
                    ...
                    Ventana.Width = Unit.Pixel(1050);
                    Ventana.KeepInScreenBounds = true;
                    Ventana.Title = "Editar impuesto Id: " + _IdMunImpuesto;
                    Ventana.VisibleStatusbar = false;
                    Ventana.Behaviors = WindowBehaviors.Close;
                    this.RadWindowManager1.Windows.Add(Ventana);
                    this.RadWindowManager1 = null;
                ...
                else if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "MUNICIPIO_IMPUESTO";
                    string _PathUrl = HttpContext.Current.Request.ServerVariables["PATH_INFO"].ToString().Trim();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtMunImpuesto"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idmun_impuesto"] };
            DataRow[] changedRows = TablaDatos.Select("idmun_impuesto = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["idmun_impuesto"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["idmun_impuesto"].ToString().Trim());
            ...
            try
            {
                ...
                ObjMunImpuesto.IdMunImpuesto = _IdRegistro;
                ObjMunImpuesto.IdEstado = changedRows[0]["id_estado"].ToString().Trim().ToUpper();
                ...
                ObjMunImpuesto.TipoProceso = 4;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjMunImpuesto);
                _log.Warn("REQUEST DELETE IMPUESTO MUNICIPIO => " + jsonRequest);

                string _MsgError = "";
                if (ObjMunImpuesto.AddUpMunImpuesto(ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtMunImpuesto"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtMunImpuesto"].AcceptChanges();
                    ...
                    ObjAuditoria.ModuloApp = "IMPUESTO_MUNICIPIO";
