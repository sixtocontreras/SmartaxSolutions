...
{
    public partial class FrmMunicipioAutoretenciones : System.Web.UI.Page
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjMunicipioAuto.TipoConsulta = 1;
                ObjMunicipioAuto.IdMunicipioAuto = null;
                ObjMunicipioAuto.IdMunicipio = this.ViewState["IdMunicipio"].ToString().Trim();
                ObjMunicipioAuto.IdFormularioImpuesto = null;
                ObjMunicipioAuto.IdEstado = null;
                ObjMunicipioAuto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los impuestos por municipio
                ObjetoDataTable = ObjMunicipioAuto.GetAllMunicipioAuto();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idmun_autoretenciones"] };
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                this.RadGrid1.DataMember = "DtMunicipioAuto";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "MUNICIPIO_AUTORETENCION";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridNumericColumnEditor editor = (GridNumericColumnEditor)item.EditManager.GetColumnEditor("numero_renglon");
                    ...
                    GridNumericColumnEditor editor4 = (GridNumericColumnEditor)item.EditManager.GetColumnEditor("valor_autoretencion");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtMunicipioAuto"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idmun_autoretenciones"] };
            DataRow[] TodosValores = TablaDatos.Select("", "idmun_autoretenciones", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    string CmbFormImpuesto = (editedItem["idformulario_impuesto"].Controls[0] as RadComboBox).SelectedItem.Text;
                    ...
                    ObjMunicipioAuto.IdMunicipioAuto = null;
                    ObjMunicipioAuto.IdMunicipio = this.ViewState["IdMunicipio"].ToString().Trim();
                    ObjMunicipioAuto.IdEstado = NuevaFila["id_estado"].ToString().Trim();
                    ObjMunicipioAuto.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjMunicipioAuto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjMunicipioAuto.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjMunicipioAuto);
                    _log.Warn("REQUEST INSERT MUNICIPIO AUTORETENCION => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjMunicipioAuto.AddUpMunicipioAuto(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        #region MOSTRAR DATOS DEL REGISTRO EN EL GRID
                        NuevaFila["idmun_autoretenciones"] = _IdRegistro;
                        NuevaFila["descripcion_formulario"] = CmbFormImpuesto.ToString().Trim();
                        NuevaFila["descripcion_anio"] = CmbAnio.ToString().Trim();
                        NuevaFila["numero_renglon"] = NuevaFila["numero_renglon"].ToString().Trim();
                        NuevaFila["valor_autoretencion2"] = ObjUtils.GetFormatNumberConSigno(NuevaFila["valor_autoretencion"].ToString().Trim());
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtMunicipioAuto"].Rows.Add(NuevaFila);
                        #endregion
                        ...
                        ObjAuditoria.ModuloApp = "MUNICIPIO_AUTORETENCION";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtMunicipioAuto"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idmun_autoretenciones"] };
            DataRow[] changedRows = TablaDatos.Select("idmun_autoretenciones = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["idmun_autoretenciones"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["idmun_autoretenciones"].ToString().Trim());
            ...
            try
            {
                ...
                ObjMunicipioAuto.IdMunicipioAuto = _IdRegistro;
                ObjMunicipioAuto.IdMunicipio = this.ViewState["IdMunicipio"].ToString().Trim();
                ObjMunicipioAuto.IdEstado = changedRows[0]["id_estado"].ToString().Trim();
                ObjMunicipioAuto.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjMunicipioAuto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjMunicipioAuto.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjMunicipioAuto);
                _log.Warn("REQUEST UPDATE MUNICIPIO AUTORETENCION => " + jsonRequest);

                string _MsgError = "";
                if (ObjMunicipioAuto.AddUpMunicipioAuto(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    #region MOSTRAR DATOS EDITADOS EN EL GRID
                    changedRows[0]["descripcion_formulario"] = CmbFormImpuesto.ToString().Trim();
                    ...
                    changedRows[0]["valor_autoretencion2"] = ObjUtils.GetFormatNumberConSigno(changedRows[0]["valor_autoretencion"].ToString().Trim());
                    changedRows[0]["descripcion_formulario"] = CmbFormImpuesto.ToString().Trim();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtMunicipioAuto"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtMunicipioAuto"].Rows[0].EndEdit();
                    #endregion
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjMunicipioAuto.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjMunicipioAuto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjMunicipioAuto.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjMunicipioAuto);
                _log.Warn("REQUEST DELETE MUNICIPIO AUTORETENCION => " + jsonRequest);

                if (ObjMunicipioAuto.AddUpMunicipioAuto(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtMunicipioAuto"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtMunicipioAuto"].AcceptChanges();
