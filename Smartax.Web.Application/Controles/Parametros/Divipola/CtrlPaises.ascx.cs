...
{
    public partial class CtrlPaises : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjPais.TipoConsulta = 1;
                ObjPais.IdPais = null;
                ObjPais.IdEstado = null;
                ObjPais.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los tipos de regimen
                ObjetoDataTable = ObjPais.GetAllPaises();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_pais"] };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Paises";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("nombre_pais");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtPaises"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_pais"] };
            DataRow[] TodosValores = TablaDatos.Select("", "id_pais", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjPais.IdPais = null;
                    ObjPais.IdEmpresa = Int32.Parse(Session["IdEmpresa"].ToString().Trim());
                    ObjPais.IdRol = Int32.Parse(Session["IdRol"].ToString().Trim());
                    ObjPais.IdUsuarioAdd = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                    ObjPais.IdUsuarioUp = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                    ObjPais.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                    ObjPais.TipoProceso = 1;
                    int _IdRegistro = 0;
                    string _MsgError = "";

                    if (ObjPais.AddUpPais(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["id_pais"] = _IdRegistro;
                        NuevaFila["nombre_pais"] = NuevaFila["nombre_pais"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtPaises"].Rows.Add(NuevaFila);
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtPaises"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_pais"] };
            DataRow[] changedRows = TablaDatos.Select("id_pais = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["id_pais"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["id_pais"].ToString().Trim());
            ...
            try
            {
                ...
                string CmbEstado = (editedItem["id_estado"].Controls[0] as RadComboBox).SelectedItem.Text;
                ObjPais.IdPais = _IdRegistro;
                ObjPais.IdEmpresa = Int32.Parse(Session["IdEmpresa"].ToString().Trim());
                ObjPais.IdRol = Int32.Parse(Session["IdRol"].ToString().Trim());
                ObjPais.IdUsuarioAdd = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                ObjPais.IdUsuarioUp = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                ObjPais.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                ObjPais.TipoProceso = 2;
                string _MsgError = "";

                if (ObjPais.AddUpPais(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["nombre_pais"] = changedRows[0]["nombre_pais"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtPaises"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtPaises"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjPais.IdUsuarioUp = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                ObjPais.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                ObjPais.TipoProceso = 3;

                if (ObjPais.AddUpPais(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtPaises"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtPaises"].AcceptChanges();
