<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoCargo.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoCargo" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE CARGOS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_cargo" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_cargo"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_cargo" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_cargo">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_cargo" HeaderText="Tipo Cargo"
                                    UniqueName="tipo_cargo" MaxLength="30">
                                </telerik:GridBoundColumn>
