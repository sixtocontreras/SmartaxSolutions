<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlDiasFestivo.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlDiasFestivo" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR DIAS FESTIVO DEL AÑO" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="iddia_festivo" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="iddia_festivo"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="iddia_festivo" EmptyDataText="" FilterControlWidth="40px"
                                    HeaderText="Id" ReadOnly="True" UniqueName="iddia_festivo">
                                </telerik:GridBoundColumn>
                                <telerik:GridDateTimeColumn DataField="dia_festivo" HeaderText="Dia Festivo"
                                    UniqueName="dia_festivo" FilterControlWidth="130px">
                                </telerik:GridDateTimeColumn>
                                <telerik:GridBoundColumn DataField="descripcion_festivo" HeaderText="Descripción"
                                    UniqueName="descripcion_festivo" MaxLength="100" FilterControlWidth="200px">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Tipo Cargo" Text="Eliminar" UniqueName="DeleteCommand">
                                </telerik:GridButtonColumn>
                            </Columns>
