<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlPeriodicidadPagos.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlPeriodicidadPagos" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR PERIODICIDAD DE PAGOS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="id_periodicidad" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="id_periodicidad"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="id_periodicidad" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="id_periodicidad">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="descripcion_periodicidad" HeaderText="Descripción"
                                    UniqueName="descripcion_periodicidad" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Periodicidad" Text="Eliminar" UniqueName="DeleteCommand">
                                </telerik:GridButtonColumn>
                            </Columns>
