<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTiposIdentificacion.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTiposIdentificacion" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE IDENTIFICACION" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_identificacion" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_identificacion"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_identificacion" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_identificacion">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_identificacion" HeaderText="Descripción"
                                    UniqueName="tipo_identificacion" MaxLength="30">
                                </telerik:GridBoundColumn>
