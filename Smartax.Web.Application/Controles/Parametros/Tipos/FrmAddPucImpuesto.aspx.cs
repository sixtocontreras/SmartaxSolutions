...
{
    public partial class FrmAddPucImpuesto : System.Web.UI.Page
    {
        private static readonly ILog _log = LogManager.GetLogger(FixedData.LOG_AUDITORIA_NAME);
        RadWindow Ventana = new RadWindow();

        PucImpuesto ObjPucImpuesto = new PucImpuesto();
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjPucImpuesto.TipoConsulta = 1;
                ObjPucImpuesto.IdPuc = Int32.Parse(this.ViewState["IdPuc"].ToString().Trim());
                ObjPucImpuesto.IdFormularioImpuesto = null;
                ObjPucImpuesto.IdEstado = null;
                ObjPucImpuesto.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los formularios
                ObjetoDataTable = ObjPucImpuesto.GetAllPucImpuesto();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idpuc_impuesto"] };
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al listar los impuestos asignados. Motivo: " + ex.ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!(this.Page.IsPostBack))
            {
                ...
                this.ViewState["IdPuc"] = Request.QueryString["IdPuc"].ToString().Trim();
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtPucImpuesto";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "ASIGNAR_PUC_IMPUESTO";
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtPucImpuesto"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idpuc_impuesto"] };
            DataRow[] TodosValores = TablaDatos.Select("", "idpuc_impuesto", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjPucImpuesto.IdPucImpuesto = null;
                    ObjPucImpuesto.IdPuc = Int32.Parse(this.ViewState["IdPuc"].ToString().Trim());
                    ObjPucImpuesto.IdEstado = NuevaFila["id_estado"].ToString().Trim().ToUpper();
                    ObjPucImpuesto.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjPucImpuesto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjPucImpuesto.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjPucImpuesto);
                    _log.Warn("REQUEST INSERT PUC IMPUESTO => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjPucImpuesto.AddUpPucImpuesto(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["idpuc_impuesto"] = _IdRegistro;
                        ...
                        this.FuenteDatos.Tables["DtPucImpuesto"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "ASIGNAR_PUC_IMPUESTO";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtPucImpuesto"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idpuc_impuesto"] };
            DataRow[] changedRows = TablaDatos.Select("idpuc_impuesto = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["idpuc_impuesto"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["idpuc_impuesto"].ToString().Trim());
            ...
            try
            {
                ...
                string CmbFormImpuesto = (editedItem["idformulario_impuesto"].Controls[0] as RadComboBox).SelectedItem.Text;
                string CmbEstado = (editedItem["id_estado"].Controls[0] as RadComboBox).SelectedItem.Text;
                ObjPucImpuesto.IdPucImpuesto = _IdRegistro;
                ObjPucImpuesto.IdPuc = Int32.Parse(this.ViewState["IdPuc"].ToString().Trim());
                ObjPucImpuesto.IdEstado = changedRows[0]["id_estado"].ToString().Trim().ToUpper();
                ObjPucImpuesto.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjPucImpuesto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjPucImpuesto.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjPucImpuesto);
                _log.Warn("REQUEST UPDATE PUC IMPUESTO => " + jsonRequest);

                string _MsgError = "";
                if (ObjPucImpuesto.AddUpPucImpuesto(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["descripcion_formulario"] = CmbFormImpuesto.ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtPucImpuesto"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtPucImpuesto"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjPucImpuesto.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjPucImpuesto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjPucImpuesto.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjPucImpuesto);
                _log.Warn("REQUEST DELETE PUC IMPUESTO => " + jsonRequest);

                if (ObjPucImpuesto.AddUpPucImpuesto(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtPucImpuesto"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtPucImpuesto"].AcceptChanges();
