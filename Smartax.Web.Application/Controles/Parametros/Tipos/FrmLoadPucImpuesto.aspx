<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadPucImpuesto.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.FrmLoadPucImpuesto" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="15pt" Text="REALIZAR CARGUE MASIVO DE IMPUESTOS AL PLAN ÚNICO DE CUENTA" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                    ...
                                    <MasterTableView DataKeyNames="id_registro" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="formulario_impuesto" HeaderText="Form. Impuesto" 
                                                UniqueName="formulario_impuesto" FilterControlWidth="80px">
                                            </telerik:GridBoundColumn>
