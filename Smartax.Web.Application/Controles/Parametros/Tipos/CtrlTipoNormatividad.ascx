<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoNormatividad.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoNormatividad" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE NORMATIVIDAD" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_normatividad" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_normatividad"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_normatividad" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_normatividad">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_normatividad" HeaderText="Tipo Normatividad"
                                    UniqueName="tipo_normatividad" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Tipo Normatividad" Text="Eliminar" UniqueName="DeleteCommand">
                                </telerik:GridButtonColumn>
                            </Columns>
