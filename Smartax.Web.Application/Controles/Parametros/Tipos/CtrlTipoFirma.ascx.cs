...
{
    public partial class CtrlTipoFirma : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjTipoFirma.TipoConsulta = 1;
                ObjTipoFirma.IdEstado = null;
                ObjTipoFirma.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los formularios
                ObjetoDataTable = ObjTipoFirma.GetAllTipoFirma();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idtipo_firma"] };
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al listar los tipos de firmas. Motivo: " + ex.ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Tipo Firma";
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtTipoFirma";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("tipo_firma");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtTipoFirma"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idtipo_firma"] };
            DataRow[] TodosValores = TablaDatos.Select("", "idtipo_firma", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjTipoFirma.IdTipoFirma = null;
                    ObjTipoFirma.TipoFirma = NuevaFila["tipo_firma"].ToString().Trim().ToUpper();
                    ObjTipoFirma.IdEstado = NuevaFila["id_estado"].ToString().Trim().ToUpper();
                    ObjTipoFirma.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjTipoFirma.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                    ObjTipoFirma.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                    ObjTipoFirma.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjTipoFirma.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjTipoFirma);
                    _log.Warn("REQUEST INSERT TIPO FIRMA => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjTipoFirma.AddUpTipoFirma(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["idtipo_firma"] = _IdRegistro;
                        NuevaFila["tipo_firma"] = NuevaFila["tipo_firma"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtTipoFirma"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "TIPO_FIRMA";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtTipoFirma"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idtipo_firma"] };
            DataRow[] changedRows = TablaDatos.Select("idtipo_firma = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["idtipo_firma"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["idtipo_firma"].ToString().Trim());
            ...
            try
            {
                ...
                string CmbEstado = (editedItem["id_estado"].Controls[0] as RadComboBox).SelectedItem.Text;
                ObjTipoFirma.IdTipoFirma = _IdRegistro;
                ObjTipoFirma.TipoFirma = changedRows[0]["tipo_firma"].ToString().Trim().ToUpper();
                ObjTipoFirma.IdEstado = changedRows[0]["id_estado"].ToString().Trim().ToUpper();
                ObjTipoFirma.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjTipoFirma.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                ObjTipoFirma.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjTipoFirma.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjTipoFirma.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjTipoFirma);
                _log.Warn("REQUEST UPDATE TIPO FIRMA => " + jsonRequest);

                string _MsgError = "";
                if (ObjTipoFirma.AddUpTipoFirma(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["tipo_firma"] = changedRows[0]["tipo_firma"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtTipoFirma"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtTipoFirma"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjTipoFirma.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjTipoFirma.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjTipoFirma.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjTipoFirma);
                _log.Warn("REQUEST DELETE TIPO FIRMA => " + jsonRequest);

                if (ObjTipoFirma.AddUpTipoFirma(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtTipoFirma"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtTipoFirma"].AcceptChanges();
