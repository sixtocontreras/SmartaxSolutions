...
{
    public partial class CtrlFormularioImpuestos : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjFormImpuesto.TipoConsulta = 1;
                ObjFormImpuesto.IdEstado = null;
                ObjFormImpuesto.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los formularios
                ObjetoDataTable = ObjFormImpuesto.GetAllFormularioImpuesto();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idformulario_impuesto"] };
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al listar los formularios. Motivo: " + ex.ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Tipo Identificacion";
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtFormularioImpuesto";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnAddConfigurar")
                {
                    #region ASIGNAR CONFIGURACION DEL FORMULARIO
                    GridDataItem item = (GridDataItem)e.Item;
                    int _IdFormImpuesto = Convert.ToInt32(item.GetDataKeyValue("idformulario_impuesto").ToString().Trim());
                    string _DescripcionFormulario = item["descripcion_formulario"].Text.ToString().Trim();
                    ...
                    Ventana.NavigateUrl = "/Controles/Parametros/Tipos/FrmAddFormConfiguracion.aspx?IdFormularioImpuesto=" + _IdFormImpuesto + "&PathUrl=" + _PathUrl;
                    Ventana.ID = "RadWindow3";
                    Ventana.VisibleOnPageLoad = true;
                    Ventana.Visible = true;
                    Ventana.Height = Unit.Pixel(675);
                    Ventana.Width = Unit.Pixel(1300);
                    Ventana.KeepInScreenBounds = true;
                    Ventana.Title = "Configuración del Formulario: " + _IdFormImpuesto + " - " + _DescripcionFormulario;
                    Ventana.VisibleStatusbar = false;
                    Ventana.Behaviors = WindowBehaviors.Close;
                    this.RadWindowManager1.Windows.Add(Ventana);
                    this.RadWindowManager1 = null;
                ...
                else if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "FORM_IMPUESTO";
                    string _PathUrl = HttpContext.Current.Request.ServerVariables["PATH_INFO"].ToString().Trim();
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("descripcion_formulario");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtFormularioImpuesto"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idformulario_impuesto"] };
            DataRow[] TodosValores = TablaDatos.Select("", "idformulario_impuesto", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjFormImpuesto.IdFormularioImpuesto = null;
                    ObjFormImpuesto.Descripcion = NuevaFila["descripcion_formulario"].ToString().Trim();
                    ObjFormImpuesto.IdEstado = NuevaFila["id_estado"].ToString().Trim();
                    ObjFormImpuesto.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjFormImpuesto.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                    ObjFormImpuesto.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                    ObjFormImpuesto.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjFormImpuesto.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjFormImpuesto);
                    _log.Warn("REQUEST INSERT FORM. IMPUESTO => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjFormImpuesto.AddUpFormularioImpuesto(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["idformulario_impuesto"] = _IdRegistro;
                        NuevaFila["descripcion_formulario"] = NuevaFila["descripcion_formulario"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtFormularioImpuesto"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "FORM_IMPUESTO";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtFormularioImpuesto"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idformulario_impuesto"] };
            DataRow[] changedRows = TablaDatos.Select("idformulario_impuesto = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["idformulario_impuesto"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["idformulario_impuesto"].ToString().Trim());
            ...
            try
            {
                ...
                string CmbEstado = (editedItem["id_estado"].Controls[0] as RadComboBox).SelectedItem.Text;
                ObjFormImpuesto.IdFormularioImpuesto = _IdRegistro;
                ObjFormImpuesto.Descripcion = changedRows[0]["descripcion_formulario"].ToString().Trim();
                ObjFormImpuesto.IdEstado = changedRows[0]["id_estado"].ToString().Trim();
                ObjFormImpuesto.IdUsuario = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                ObjFormImpuesto.IdEmpresa = Int32.Parse(Session["IdEmpresa"].ToString().Trim());
                ObjFormImpuesto.IdRol = Int32.Parse(Session["IdRol"].ToString().Trim());
                ObjFormImpuesto.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                ObjFormImpuesto.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjFormImpuesto);
                _log.Warn("REQUEST UPDATE FORM. IMPUESTO => " + jsonRequest);

                string _MsgError = "";
                if (ObjFormImpuesto.AddUpFormularioImpuesto(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["descripcion_formulario"] = changedRows[0]["descripcion_formulario"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtFormularioImpuesto"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtFormularioImpuesto"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjFormImpuesto.IdRol = Int32.Parse(Session["IdRol"].ToString().Trim());
                ObjFormImpuesto.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                ObjFormImpuesto.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjFormImpuesto);
                _log.Warn("REQUEST DELETE FORM. IMPUESTO => " + jsonRequest);

                if (ObjFormImpuesto.AddUpFormularioImpuesto(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtFormularioImpuesto"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtFormularioImpuesto"].AcceptChanges();
