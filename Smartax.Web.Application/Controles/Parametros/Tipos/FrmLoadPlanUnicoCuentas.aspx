<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmLoadPlanUnicoCuentas.aspx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.FrmLoadPlanUnicoCuentas" %>
                    ...
                    <table cellpadding="4" cellspacing="0" class="Tab" style="width: 100%;">
                        <tr>
                            <td align="center" colspan="4" bgcolor="#999999">
                                <asp:Label ID="Label1" runat="server" CssClass="SubTitle" Font-Bold="True" Font-Size="15pt" Text="REALIZAR CARGUE MASIVO PLAN ÚNICO DE CUENTA" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                    ...
                                    <MasterTableView DataKeyNames="id_registro" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="cod_cuenta_padre" HeaderText="Cuenta Padre" 
                                                UniqueName="cod_cuenta_padre" FilterControlWidth="60px">
                                            </telerik:GridBoundColumn>
                                            ...
                                            <telerik:GridBoundColumn DataField="base_gravable" HeaderText="Base Gravable" 
                                                UniqueName="base_gravable" FilterControlWidth="50px">
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="movimiento" HeaderText="Movimiento" 
                                                UniqueName="movimiento" FilterControlWidth="50px">
                                            </telerik:GridBoundColumn>
