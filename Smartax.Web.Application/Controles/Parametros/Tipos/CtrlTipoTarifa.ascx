<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoTarifa.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoTarifa" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE TARIFAS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_tarifa" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_tarifa"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_tarifa" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_tarifa">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="descripcion_tarifa" HeaderText="Descripción"
                                    UniqueName="descripcion_tarifa" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Tipo Tarifa" Text="Eliminar" UniqueName="DeleteCommand">
                                </telerik:GridButtonColumn>
                            </Columns>
