<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoFirma.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoFirma" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE FIRMAS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_firma" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_firma"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_firma" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_firma">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_firma" HeaderText="Tipo Firma"
                                    UniqueName="tipo_firma" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Tipo Firma" Text="Eliminar" UniqueName="DeleteCommand">
