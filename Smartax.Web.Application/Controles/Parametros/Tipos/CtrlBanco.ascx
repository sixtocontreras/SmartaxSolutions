<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlBanco.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlBanco" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR INFORMACIÓN DE BANCOS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="id_banco" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="id_banco"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="id_banco" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="id_banco">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="nombre_banco" HeaderText="Nombre"
                                    UniqueName="nombre_banco" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Banco" Text="Eliminar" UniqueName="DeleteCommand">
