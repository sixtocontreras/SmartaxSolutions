...
{
    public partial class CtrlTipoClasificacion : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjTipoClasificacion.TipoConsulta = 1;
                ObjTipoClasificacion.IdEstado = null;
                ObjTipoClasificacion.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los formularios
                ObjetoDataTable = ObjTipoClasificacion.GetAllTipoClasificacion();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idtipo_clasificacion"] };
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al listar los tipos de clasificación. Motivo: " + ex.ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Tipo Clasificación";
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtTipoClasificacion";
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error con el evento RadGrid1_NeedDataSource del Tipo de clasificación. Motivo: " + ex.ToString();
                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                Ventana.ID = "RadWindow2";
                Ventana.VisibleOnPageLoad = true;
                Ventana.Visible = true;
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("tipo_clasificacion");
                ...
                catch (Exception ex)
                {
                    ...
                    RadWindow Ventana = new RadWindow();
                    Ventana.Modal = true;
                    string _MsgError = "Error con el evento RadGrid1_ItemCreated del Tipo de clasificación. Motivo: " + ex.ToString();
                    Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                    Ventana.ID = "RadWindow2";
                    Ventana.VisibleOnPageLoad = true;
                    Ventana.Visible = true;
        ...
        protected void RadGrid1_PageIndexChanged(object sender, GridPageChangedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error con el evento RadGrid1_PageIndexChanged del Tipo de clasificación. Motivo: " + ex.ToString();
                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                Ventana.ID = "RadWindow2";
                Ventana.VisibleOnPageLoad = true;
                Ventana.Visible = true;
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtTipoClasificacion"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idtipo_clasificacion"] };
            DataRow[] TodosValores = TablaDatos.Select("", "idtipo_clasificacion", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjTipoClasificacion.IdTipoClasificacion = null;
                    ObjTipoClasificacion.TipoClasificacion = NuevaFila["tipo_clasificacion"].ToString().Trim();
                    ObjTipoClasificacion.IdEstado = NuevaFila["id_estado"].ToString().Trim();
                    ObjTipoClasificacion.IdUsuario = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                    ObjTipoClasificacion.IdEmpresa = Int32.Parse(Session["IdEmpresa"].ToString().Trim());
                    ObjTipoClasificacion.IdRol = Int32.Parse(Session["IdRol"].ToString().Trim());
                    ObjTipoClasificacion.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                    ObjTipoClasificacion.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjTipoClasificacion);
                    _log.Warn("REQUEST INSERT TIPO CLASIFICACION => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjTipoClasificacion.AddUpTipoClasificacion(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["idtipo_clasificacion"] = _IdRegistro;
                        NuevaFila["tipo_clasificacion"] = NuevaFila["tipo_clasificacion"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtTipoClasificacion"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "TIPO_ACT_CLASIFICACION";
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al registrar el Tipo de clasificación. Motivo: " + ex.ToString();
                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                Ventana.ID = "RadWindow2";
                Ventana.VisibleOnPageLoad = true;
                Ventana.Visible = true;
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtTipoClasificacion"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idtipo_clasificacion"] };
            DataRow[] changedRows = TablaDatos.Select("idtipo_clasificacion = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["idtipo_clasificacion"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["idtipo_clasificacion"].ToString().Trim());
            ...
            try
            {
                ...
                string CmbEstado = (editedItem["id_estado"].Controls[0] as RadComboBox).SelectedItem.Text;
                ObjTipoClasificacion.IdTipoClasificacion = _IdRegistro;
                ObjTipoClasificacion.TipoClasificacion = changedRows[0]["tipo_clasificacion"].ToString().Trim();
                ObjTipoClasificacion.IdEstado = changedRows[0]["id_estado"].ToString().Trim();
                ObjTipoClasificacion.IdUsuario = Int32.Parse(Session["IdUsuario"].ToString().Trim());
                ObjTipoClasificacion.IdEmpresa = Int32.Parse(Session["IdEmpresa"].ToString().Trim());
                ObjTipoClasificacion.IdRol = Int32.Parse(Session["IdRol"].ToString().Trim());
                ObjTipoClasificacion.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                ObjTipoClasificacion.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjTipoClasificacion);
                _log.Warn("REQUEST UPDATE TIPO CLASIFICACION => " + jsonRequest);

                string _MsgError = "";
                if (ObjTipoClasificacion.AddUpTipoClasificacion(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["tipo_clasificacion"] = changedRows[0]["tipo_clasificacion"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtTipoClasificacion"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtTipoClasificacion"].Rows[0].EndEdit();
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al editar el Tipo de clasificación. Motivo: " + ex.ToString();
                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                Ventana.ID = "RadWindow2";
                Ventana.VisibleOnPageLoad = true;
                Ventana.Visible = true;
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjTipoClasificacion.IdRol = Int32.Parse(Session["IdRol"].ToString().Trim());
                ObjTipoClasificacion.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();
                ObjTipoClasificacion.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjTipoClasificacion);
                _log.Warn("REQUEST DELETE TIPO CLASIFICACION => " + jsonRequest);

                if (ObjTipoClasificacion.AddUpTipoClasificacion(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtTipoClasificacion"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtTipoClasificacion"].AcceptChanges();
            ...
            catch (Exception ex)
            {
                ...
                RadWindow Ventana = new RadWindow();
                Ventana.Modal = true;
                string _MsgError = "Error al eliminar el Tipo de clasificación. Motivo: " + ex.ToString();
                Ventana.NavigateUrl = "/Controles/General/FrmMensaje.aspx?strMensaje=" + _MsgError;
                Ventana.ID = "RadWindow2";
                Ventana.VisibleOnPageLoad = true;
                Ventana.Visible = true;
