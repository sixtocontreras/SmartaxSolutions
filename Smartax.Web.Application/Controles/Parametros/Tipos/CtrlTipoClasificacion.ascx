<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoClasificacion.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoClasificacion" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE CLASIFICACION" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_clasificacion" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_clasificacion"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_clasificacion" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_clasificacion">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_clasificacion" HeaderText="Tipo Clasificación"
                                    UniqueName="tipo_clasificacion" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Tipo Clasificación" Text="Eliminar" UniqueName="DeleteCommand">
                                </telerik:GridButtonColumn>
                            </Columns>
