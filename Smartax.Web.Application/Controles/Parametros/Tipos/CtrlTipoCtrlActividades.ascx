<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoCtrlActividades.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoCtrlActividades" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS CONTROL DE ACTIVIDADES" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_ctrl_actividades" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_ctrl_actividades"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_ctrl_actividades" EmptyDataText="" HeaderText="Id"
                                    ReadOnly="True" UniqueName="idtipo_ctrl_actividades" FilterControlWidth="40px">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_ctrl_actividad" HeaderText="Tipo Actividad"
                                    UniqueName="tipo_ctrl_actividad" MaxLength="60" FilterControlWidth="200px">
                                </telerik:GridBoundColumn>
                                <telerik:GridCheckBoxColumn DataField="doble_cantidad" HeaderText="Doble Cantidad"
                                    UniqueName="doble_cantidad">
                                </telerik:GridCheckBoxColumn>
                                <telerik:GridCheckBoxColumn DataField="maneja_estadistica" HeaderText="Maneja Estadistica"
                                    UniqueName="maneja_estadistica">
                                </telerik:GridCheckBoxColumn>
                                ...
                                <telerik:GridBoundColumn DataField="fecha_modificacion" HeaderText="F. Modificación"
                                    UniqueName="fecha_modificacion" ReadOnly="true" FilterControlWidth="70px">
                                </telerik:GridBoundColumn>
