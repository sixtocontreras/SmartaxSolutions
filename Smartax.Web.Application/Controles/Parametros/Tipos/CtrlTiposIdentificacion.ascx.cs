...
{
    public partial class CtrlTiposIdentificacion : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjTipoIde.TipoConsulta = 1;
                ObjTipoIde.IdEstado = null;
                ObjTipoIde.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los tipos de regimen
                ObjetoDataTable = ObjTipoIde.GetAllTipoIde();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["idtipo_identificacion"] };
        ...
        protected void RadGrid1_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            try
            {
                ...
                RadGrid1.DataMember = "DtTiposIdentificacion";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "TIPO_DOCUMENTO";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("tipo_identificacion");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtTiposIdentificacion"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idtipo_identificacion"] };
            DataRow[] TodosValores = TablaDatos.Select("", "idtipo_identificacion", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjTipoIde.IdTipoIdentificacion = null;
                    ObjTipoIde.Descripcion = NuevaFila["tipo_identificacion"].ToString().Trim().ToUpper();
                    ObjTipoIde.IdEstado = NuevaFila["id_estado"].ToString().Trim();
                    ObjTipoIde.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjTipoIde.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                    ObjTipoIde.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                    ObjTipoIde.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjTipoIde.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjTipoIde);
                    _log.Warn("REQUEST INSERT TIPO DOCUMENTO => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjTipoIde.AddUpIdentificacion(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["idtipo_identificacion"] = _IdRegistro;
                        NuevaFila["tipo_identificacion"] = NuevaFila["tipo_identificacion"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtTiposIdentificacion"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "TIPO_DOCUMENTO";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtTiposIdentificacion"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["idtipo_identificacion"] };
            DataRow[] changedRows = TablaDatos.Select("idtipo_identificacion = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["idtipo_identificacion"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["idtipo_identificacion"].ToString().Trim());
            ...
            try
            {
                ...
                string CmbEstado = (editedItem["id_estado"].Controls[0] as RadComboBox).SelectedItem.Text;
                ObjTipoIde.IdTipoIdentificacion = _IdRegistro;
                ObjTipoIde.Descripcion = changedRows[0]["tipo_identificacion"].ToString().Trim().ToUpper();
                ObjTipoIde.IdEstado = changedRows[0]["id_estado"].ToString().Trim();
                ObjTipoIde.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjTipoIde.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                ObjTipoIde.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjTipoIde.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjTipoIde.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjTipoIde);
                _log.Warn("REQUEST UPDATE TIPO DOCUMENTO => " + jsonRequest);

                string _MsgError = "";
                if (ObjTipoIde.AddUpIdentificacion(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["tipo_identificacion"] = changedRows[0]["tipo_identificacion"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtTiposIdentificacion"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtTiposIdentificacion"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjTipoIde.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjTipoIde.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjTipoIde.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjTipoIde);
                _log.Warn("REQUEST DELETE TIPO DOCUMENTO => " + jsonRequest);

                if (ObjTipoIde.AddUpIdentificacion(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtTiposIdentificacion"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtTiposIdentificacion"].AcceptChanges();
