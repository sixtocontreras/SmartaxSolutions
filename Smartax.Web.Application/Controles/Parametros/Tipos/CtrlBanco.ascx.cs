...
{
    public partial class CtrlBanco : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjBanco.TipoConsulta = 1;
                ObjBanco.IdEstado = null;
                ObjBanco.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los formularios
                ObjetoDataTable = ObjBanco.GetAllBancos();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_banco"] };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Banco";
        ...
        protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "BtnLogsAuditoria")
                {
                    ...
                    string _ModuloApp = "nombre_banco";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("nombre_banco");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtBancos"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_banco"] };
            DataRow[] TodosValores = TablaDatos.Select("", "id_banco", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                if ((NuevaFila != null))
                {
                    ...
                    ObjBanco.IdBanco = null;
                    ObjBanco.IdEstado = NuevaFila["id_estado"].ToString().Trim().ToUpper();
                    ObjBanco.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjBanco.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                    ObjBanco.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                    ObjBanco.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjBanco.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjBanco);
                    _log.Warn("REQUEST INSERT BANCO => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjBanco.AddUpBanco(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["id_banco"] = _IdRegistro;
                        NuevaFila["nombre_banco"] = NuevaFila["nombre_banco"].ToString().Trim().ToUpper();
                        NuevaFila["codigo_estado"] = CmbEstado.ToString().Trim();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtBancos"].Rows.Add(NuevaFila);
                        ...
                        ObjAuditoria.ModuloApp = "nombre_banco";
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtBancos"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_banco"] };
            DataRow[] changedRows = TablaDatos.Select("id_banco = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["id_banco"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["id_banco"].ToString().Trim());
            ...
            try
            {
                ...
                string CmbEstado = (editedItem["id_estado"].Controls[0] as RadComboBox).SelectedItem.Text;
                ObjBanco.IdBanco = _IdRegistro;
                ObjBanco.IdEstado = changedRows[0]["id_estado"].ToString().Trim().ToUpper();
                ObjBanco.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjBanco.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                ObjBanco.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjBanco.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjBanco.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjBanco);
                _log.Warn("REQUEST UPDATE BANCO => " + jsonRequest);

                string _MsgError = "";
                if (ObjBanco.AddUpBanco(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["nombre_banco"] = changedRows[0]["nombre_banco"].ToString().Trim().ToUpper();
                    changedRows[0]["codigo_estado"] = CmbEstado.ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtBancos"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtBancos"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjBanco.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                ObjBanco.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjBanco.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjBanco);
                _log.Warn("REQUEST DELETE BANCO => " + jsonRequest);

                if (ObjBanco.AddUpBanco(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtBancos"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtBancos"].AcceptChanges();
