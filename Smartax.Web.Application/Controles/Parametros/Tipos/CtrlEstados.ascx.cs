...
{
    public partial class CtrlEstados : System.Web.UI.UserControl
    {
        ...
        public DataSet GetDatosGrilla()
        {
            ...
            try
            {
                ObjEstado.TipoConsulta = 1;
                ObjEstado.IdEstado = null;
                ObjEstado.MotorBaseDatos = Session["MotorBaseDatos"].ToString().Trim();

                //Mostrar los tipos de regimen
                ObjetoDataTable = ObjEstado.GetAllEstados();
                ObjetoDataTable.PrimaryKey = new DataColumn[] { ObjetoDataTable.Columns["id_estado"] };
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Page.Title = this.Page.Title + "Estados";
        ...
        protected void RadGrid1_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if ((e.Item is GridEditableItem && e.Item.IsInEditMode))
            {
                try
                {
                    ...
                    //--Validar campo codigo estado
                    GridTextBoxColumnEditor editor = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("codigo_estado");
                    ...
                    //--Validar campo codigo estado
                    GridTextBoxColumnEditor editor2 = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("descripcion_estado");
        ...
        protected void RadGrid1_InsertCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            DataTable TablaDatos = this.FuenteDatos.Tables["DtEstados"]; ;
            DataRow NuevaFila = TablaDatos.NewRow();
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_estado"] };
            DataRow[] TodosValores = TablaDatos.Select("", "id_estado", DataViewRowState.CurrentRows); ;
            ...
            try
            {
                ...
                {
                    ObjEstado.IdEstado = null;
                    ObjEstado.Codigo = NuevaFila["codigo_estado"].ToString().Trim();
                    ObjEstado.DescripcionEstado = NuevaFila["descripcion_estado"].ToString().Trim();
                    ObjEstado.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                    ObjEstado.IdEmpresa = Int32.Parse(this.Session["IdEmpresa"].ToString().Trim());
                    ObjEstado.IdRol = Int32.Parse(this.Session["IdRol"].ToString().Trim());
                    ObjEstado.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                    ObjEstado.TipoProceso = 1;

                    //--AQUI SERIALIZAMOS EL OBJETO CLASE
                    JavaScriptSerializer js = new JavaScriptSerializer();
                    string jsonRequest = js.Serialize(ObjEstado);
                    _log.Warn("REQUEST INSERT ESTADO => " + jsonRequest);

                    int _IdRegistro = 0;
                    string _MsgError = "";
                    if (ObjEstado.AddUpEstado(NuevaFila, ref _IdRegistro, ref _MsgError))
                    {
                        NuevaFila["id_estado"] = _IdRegistro;
                        NuevaFila["codigo_estado"] = NuevaFila["codigo_estado"].ToString().Trim().ToUpper();
                        NuevaFila["descripcion_estado"] = NuevaFila["descripcion_estado"].ToString().Trim().ToUpper();
                        NuevaFila["fecha_registro"] = DateTime.Now;
                        this.FuenteDatos.Tables["DtEstados"].Rows.Add(NuevaFila);
        ...
        protected void RadGrid1_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            TablaDatos = this.FuenteDatos.Tables["DtEstados"];
            TablaDatos.PrimaryKey = new DataColumn[] { TablaDatos.Columns["id_estado"] };
            DataRow[] changedRows = TablaDatos.Select("id_estado = " + Int32.Parse(editedItem.OwnerTableView.DataKeyValues[editedItem.ItemIndex]["id_estado"].ToString()));
            int _IdRegistro = Int32.Parse(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["id_estado"].ToString().Trim());
            ...
            try
            {
                ...
                ObjEstado.IdEstado = _IdRegistro;
                ObjEstado.Codigo = changedRows[0]["codigo_estado"].ToString().Trim();
                ObjEstado.DescripcionEstado = changedRows[0]["descripcion_estado"].ToString().Trim();
                ObjEstado.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjEstado.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjEstado.TipoProceso = 2;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjEstado);
                _log.Warn("REQUEST UPDATE ESTADO => " + jsonRequest);

                string _MsgError = "";
                if (ObjEstado.AddUpEstado(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    changedRows[0]["codigo_estado"] = changedRows[0]["codigo_estado"].ToString().Trim().ToUpper();
                    changedRows[0]["descripcion_estado"] = changedRows[0]["descripcion_estado"].ToString().Trim().ToUpper();
                    this.FuenteDatos.Tables["DtEstados"].Rows[0].AcceptChanges();
                    this.FuenteDatos.Tables["DtEstados"].Rows[0].EndEdit();
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            try
            {
                ...
                ObjEstado.IdUsuario = Int32.Parse(this.Session["IdUsuario"].ToString().Trim());
                ObjEstado.MotorBaseDatos = this.Session["MotorBaseDatos"].ToString().Trim();
                ObjEstado.TipoProceso = 3;

                //--AQUI SERIALIZAMOS EL OBJETO CLASE
                JavaScriptSerializer js = new JavaScriptSerializer();
                string jsonRequest = js.Serialize(ObjEstado);
                _log.Warn("REQUEST DELETE ESTADO => " + jsonRequest);

                if (ObjEstado.AddUpEstado(changedRows[0], ref _IdRegistro, ref _MsgError))
                {
                    this.FuenteDatos.Tables["DtEstados"].Rows.Find(_IdRegistro).Delete();
                    this.FuenteDatos.Tables["DtEstados"].AcceptChanges();
