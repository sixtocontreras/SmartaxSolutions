<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlFormularioImpuestos.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlFormularioImpuestos" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE FORMULARIOS IMPUESTOS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idformulario_impuesto" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idformulario_impuesto"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idformulario_impuesto" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idformulario_impuesto">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="descripcion_formulario" HeaderText="Descripción"
                                    UniqueName="descripcion_formulario" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="BtnAddConfigurar" Text="Configurar formulario"
                                    UniqueName="BtnAddConfigurar" ImageUrl="/Imagenes/Iconos/16/script_edit.png">
                                </telerik:GridButtonColumn>
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ConfirmText="¿Se Encuentra Seguro de Eliminar el registro Seleccionado ...!"
                                    ConfirmTitle="Eliminar Formulario" Text="Eliminar" UniqueName="DeleteCommand">
                                </telerik:GridButtonColumn>
                            </Columns>
