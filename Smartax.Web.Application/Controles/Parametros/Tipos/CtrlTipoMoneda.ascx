<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoMoneda.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoMoneda" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE MONEDAS" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_moneda" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_moneda"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_moneda" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_moneda">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="codigo_moneda" HeaderText="Código Moneda"
                                    UniqueName="codigo_moneda" MaxLength="6">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_moneda" HeaderText="Tipo Moneda"
                                    UniqueName="tipo_moneda" MaxLength="30">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" ConfirmDialogType="RadWindow"
                                    ...
                                    ConfirmTitle="Eliminar Tipo Moneda" Text="Eliminar" UniqueName="DeleteCommand">
                                </telerik:GridButtonColumn>
                            </Columns>
