<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtrlTipoNivel.ascx.cs" Inherits="Smartax.Web.Application.Controles.Parametros.Tipos.CtrlTipoNivel" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td align="center" bgcolor="#999999">
                    <asp:Label ID="LbTitulo" runat="server" CssClass="SubTitle" Text="REGISTRAR TIPOS DE NIVELES" Font-Bold="True" Font-Size="16pt" ForeColor="White"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center">
                    <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="True"
                        ...
                        <MasterTableView EditMode="PopUp" CommandItemDisplay="Top" DataKeyNames="idtipo_nivel" Name="Grilla" NoMasterRecordsText="No hay Registros para Mostrar">
                            <EditFormSettings CaptionDataField="idtipo_nivel"
                            ...
                            <Columns>
                                <telerik:GridBoundColumn DataField="idtipo_nivel" EmptyDataText=""
                                    HeaderText="Id" ReadOnly="True" UniqueName="idtipo_nivel">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="tipo_nivel" HeaderText="Tipo Nivel"
                                    UniqueName="tipo_nivel" MaxLength="30">
                                </telerik:GridBoundColumn>
