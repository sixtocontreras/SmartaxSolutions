...
{
    public class EjecucionXLoteUser
    {
        ...
        public object IdEjecucionLoteUser { get; set; }
        ...
        public DataTable GetAllEjecucionUserSinAsignar()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtEjecucionUserSinAsignar";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_ejec_lote_user_sin_asignar", (PgSqlConnection)myConnectionDb);
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_ejecucion_lote_usuario]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetAllEjecucionXLoteUser()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtEjecucionXLoteUser";
            try
            {
                #region DEFINICION OBJETO DE CONEXION A LA DB.
                StringBuilder sSQL = new StringBuilder();
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    #region OBTENER DATOS DE LA DB DE POSTGRESQL
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_ejecucion_lote_user", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
                    ...
                    TablaDatos.Columns.Add("idejec_lote_usuario", typeof(Int32));
                    TablaDatos.Columns.Add("id_usuario", typeof(Int32));
                    TablaDatos.Columns.Add("nombre_usuario");
                    TablaDatos.Columns.Add("id_estado", typeof(Int32));
                    TablaDatos.Columns.Add("codigo_estado");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idejec_lote_usuario"] = Convert.ToInt32(TheDataReaderPostgreSQL["idejec_lote_usuario"].ToString().Trim());
                            Fila["id_usuario"] = Convert.ToInt32(TheDataReaderPostgreSQL["id_usuario"].ToString().Trim());
                            Fila["nombre_usuario"] = TheDataReaderPostgreSQL["nombre_usuario"].ToString().Trim();
        ...
        public DataTable GetEjecucionXLoteUser()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtEjecucionXLoteUser";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idejecucion_lote");
                    TablaDatos.Columns.Add("nombre_proceso");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idejecucion_lote"] = TheDataReaderPostgreSQL["idejecucion_lote"].ToString().Trim();
                            Fila["nombre_proceso"] = TheDataReaderPostgreSQL["nombre_proceso"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                    #endregion
        ...
        public bool AddUpEjecucionXLoteUser(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_ejecucion_lote_user", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idejec_lote_usuario", IdEjecucionLoteUser);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idejecucion_lote", IdEjecucionLote);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idusuario", IdUsuario);
        ...
        public bool AddUpEjecucionXLoteUser(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
