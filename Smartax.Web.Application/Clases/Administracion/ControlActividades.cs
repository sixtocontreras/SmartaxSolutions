...
namespace Smartax.Web.Application.Clases.Administracion
{
    public class ControlActividades
    {
        ...
        public object IdControlActividadRol { get; set; }
        ...
        public string CantidadValidar { get; set; }
        ...
        public DataTable GetAllActividades()
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_control_actividades", (PgSqlConnection)myConnectionDb);
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idcontrol_actividad"] = Convert.ToInt32(TheDataReaderPostgreSQL["idcontrol_actividad"].ToString().Trim());
                            Fila["idtipo_ctrl_actividades"] = Convert.ToInt32(TheDataReaderPostgreSQL["idtipo_ctrl_actividades"].ToString().Trim());
        ...
        public DataTable GetInfoActividad()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtControlActividades";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("descripcion_actividad");
                    TablaDatos.Columns.Add("porc_cumplimiento", typeof(Double));
                    TablaDatos.Columns.Add("cantidad_validar", typeof(Int32));
                    TablaDatos.Columns.Add("del_sistema", typeof(bool));
                    TablaDatos.Columns.Add("id_estado", typeof(Int32));
                    TablaDatos.Columns.Add("codigo_estado");
                    TablaDatos.Columns.Add("fecha_modificacion");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["descripcion_actividad"] = TheDataReaderPostgreSQL["descripcion_actividad"].ToString().Trim();
                            Fila["porc_cumplimiento"] = Double.Parse(TheDataReaderPostgreSQL["porc_cumplimiento"].ToString().Trim());
                            Fila["cantidad_validar"] = Int32.Parse(TheDataReaderPostgreSQL["cantidad_validar"].ToString().Trim());
                            Fila["del_sistema"] = TheDataReaderPostgreSQL["del_sistema"].ToString().Trim().Equals("S") ? true : false;
        ...
        public DataTable GetActividadesSinAsignar()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtActividadesSinAsignar";
            try
            {
                #region DEFINICION OBJETO DE CONEXION A LA DB.
                StringBuilder sSQL = new StringBuilder();
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    #region OBTENER DATOS DE LA DB DE POSTGRESQL
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_actividades_sin_asignar", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
        ...
        public DataTable GetActividadesAsignadas()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtActividadesAsignadas";
            try
            {
                #region DEFINICION OBJETO DE CONEXION A LA DB.
                StringBuilder sSQL = new StringBuilder();
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    #region OBTENER DATOS DE LA DB DE POSTGRESQL
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_actividades_rol_asignadas", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
                    ...
                    TablaDatos.Columns.Add("idcontrol_activ_rol", typeof(Int32));
                    TablaDatos.Columns.Add("id_cliente");
                    TablaDatos.Columns.Add("nombre_cliente");
                    TablaDatos.Columns.Add("idcontrol_actividad", typeof(Int32));
                    TablaDatos.Columns.Add("codigo_actividad");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idcontrol_activ_rol"] = Convert.ToInt32(TheDataReaderPostgreSQL["idcontrol_activ_rol"].ToString().Trim());
                            Fila["id_cliente"] = TheDataReaderPostgreSQL["id_cliente"].ToString().Trim();
                            Fila["nombre_cliente"] = TheDataReaderPostgreSQL["nombre_cliente"].ToString().Trim();
                            Fila["idcontrol_actividad"] = Convert.ToInt32(TheDataReaderPostgreSQL["idcontrol_actividad"].ToString().Trim());
                            Fila["codigo_actividad"] = TheDataReaderPostgreSQL["codigo_actividad"].ToString().Trim();
        ...
        public bool AddUpControlActividades(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_control_actividades", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
                    //--
                    string _Descripcion = Fila["descripcion_actividad"].ToString().Trim().ToUpper().Replace("Á", "A").Replace("É", "E").Replace("Í", "I").Replace("Ó", "O").Replace("Ú", "U").Replace("Ñ", "N");
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idcontrol_actividad", IdControlActividad);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idform_impuesto", Fila["idformulario_impuesto"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idcliente", IdCliente);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_codigo_actividad", Fila["codigo_actividad"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_descripcion_actividad", _Descripcion);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_porc_cumplimiento", Fila["porc_cumplimiento"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_del_sistema", Convert.ToBoolean(Fila["del_sistema"].ToString().Trim()) == true ? "S" : "N");
            ...
            {
                retValor = false;
                _MsgError = "Error al registrar la actividad economica. Motivo: " + ex.Message.ToString().Trim();
        ...
        public bool AddUpControlActividades(ref int _IdRegistro, ref string _MsgError)
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_anio_gravable", AnioGravable);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idcliente", IdCliente);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_codigo_actividad", CodigoActividad);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_descripcion_actividad", ObjUtils.GetLimpiarCadena(DescripcionActividad.ToString().Trim().ToUpper()));
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_porc_cumplimiento", PorcCumplimiento);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_cantidad_validar", CantidadValidar);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_del_sistema", DelSistema);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idestado", IdEstado);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idusuario", IdUsuario);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_proceso", TipoProceso);
                    PgSqlParameter _IdRegRetorno = new PgSqlParameter("@p_out_id_registro", SqlDbType.Int);
        ...
        public bool AddUpActividadesRol(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    #region REGISTRAR DATO CON EL SP EN LA DB POSTGRESQL
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_rol_actividades", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
                    //--
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idcontrol_activ_rol", IdControlActividadRol);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idcliente", IdCliente);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idcontrol_actividad", IdControlActividad);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idrol", IdRol);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_fecha_inicial", FechaInicial);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_fecha_final", FechaFinal);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idestado", IdEstado);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idusuario", IdUsuario);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_proceso", TipoProceso);
                    PgSqlParameter _IdRegRetorno = new PgSqlParameter("@p_out_id_registro", SqlDbType.Int);
            ...
            {
                retValor = false;
                _MsgError = "Error al registrar la actividad al rol. Motivo: " + ex.Message.ToString().Trim();
                _log.Error(_MsgError.ToString().Trim());
            }
            finally
            {
        ...
        public bool AddUpActividadesRol(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idcontrol_actividad", IdControlActividad);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idrol", IdRol);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_fecha_inicial", Convert.ToDateTime(Fila["fecha_inicial"].ToString().Trim()).ToString("yyyy-MM-dd"));
