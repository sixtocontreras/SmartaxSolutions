...
namespace Smartax.Web.Application.Clases.Seguridad
{
    public class TiposProceso
    {
        ...
        public object IdTipoProceso { get; set; }
        ...
        public DataTable GetTipoProceso()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoProceso";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_tarea", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("idtipo_tarea");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idtipo_tarea"] = TheDataReaderPostgreSQL["idtipo_tarea"].ToString().Trim();
