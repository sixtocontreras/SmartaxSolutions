...
namespace Smartax.Web.Application.Clases.Seguridad
{
    public class TipoEnvioTareas
    {
        ...
        public object IdTipoEnvio { get; set; }
        ...
        public DataTable GetTipoEnvio()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoEnvio";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_envio_alerta", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("idtipo_envio");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idtipo_envio"] = TheDataReaderPostgreSQL["idtipo_envio"].ToString().Trim();
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_tipo_envio_alerta]. Motivo: " + ex.Message);
            }
            finally
            {
