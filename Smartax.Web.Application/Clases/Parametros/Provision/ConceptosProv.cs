...
namespace Smartax.Web.Application.Clases.Parametros.Provision
{
    public class ConceptosProv
    {
        ...
        internal DataTable GetAllConceptosProv()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtConceptosProv";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_conceptos_prov_ica", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("cod_concepto");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["cod_concepto"] = TheDataReaderPostgreSQL["cod_concepto"].ToString().Trim();
        ...
        internal DataTable GetConceptosProv()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtConceptosProv";
            try
        ...
        internal bool AddUpConceptoProv(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_conceptos_prov_ica", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_id_conceptos_prov_ica", IdConceptosProvIca);
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_cod_concepto", CodConcepto.Trim().ToUpper());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_desc_concepto", Descripcion.ToString().Trim().ToUpper());
