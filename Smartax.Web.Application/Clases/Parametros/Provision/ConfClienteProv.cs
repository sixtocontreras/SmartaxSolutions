...
namespace Smartax.Web.Application.Clases.Parametros.Provision
{
    public class ConfClienteProv
    {
        ...
        public object IdConfClienteProv { get; set; }
        ...
        #endregion
        internal DataTable GetAllConfClientProv()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtConfClienteProv";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_conf_cliente_prov_ica", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("id_conf_cliente_prov_ica", typeof(Int32));
                    ...
                    TablaDatos.Columns.Add("desc_comp");
                    TablaDatos.Columns.Add("nivel", typeof(Int32));
                    TablaDatos.Columns.Add("desc_nivel");
                    TablaDatos.Columns.Add("id_nivel_prov_ica");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["id_conf_cliente_prov_ica"] = Convert.ToInt32(TheDataReaderPostgreSQL["id_conf_cliente_prov_ica"].ToString().Trim());
                            ...
                            Fila["desc_comp"] = TheDataReaderPostgreSQL["desc_comp"].ToString().Trim();
        ...
        internal bool AddUpConfClientProv(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_conf_cliente_prov_ica", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_id_conceptos_prov_ica", IdConfClienteProv);
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_desc_comp", Descripcion.ToString().Trim().ToUpper());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_nivel", Nivel);
