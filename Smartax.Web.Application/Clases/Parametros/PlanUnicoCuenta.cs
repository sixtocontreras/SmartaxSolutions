...
namespace Smartax.Web.Application.Clases.Parametros
{
    public class PlanUnicoCuenta
    {
        ...
        public int IdTipoNaturaleza { get; set; }
        ...
        public string ArrayPuc { get; set; }
        ...
        public DataTable GetAllPuc()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtPlanUnicoCuentas";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_plan_unico_cuenta", (PgSqlConnection)myConnectionDb);
        ...
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtCuentas";
            try
            {
                #region DEFINICION OBJETO DE CONEXION A LA DB.
                StringBuilder sSQL = new StringBuilder();
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            string _IdPuc = TheDataReaderPostgreSQL["id_puc"].ToString().Trim();
                            ...
                            Fila["cuenta_contable"] = _IdPuc + " - " + _CodigoCuenta + " " + _NombreCuenta;
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                    #endregion
        ...
        public bool AddUpPuc(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_plan_unico_cuenta", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idpuc", IdPuc);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_codigo_cuenta", Fila["codigo_cuenta"].ToString().Trim().ToUpper());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_cod_cuenta_padre", Fila["cod_cuenta_padre"].ToString().Trim().Length > 0 ? Fila["cod_cuenta_padre"].ToString().Trim().ToUpper() : "");
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_nombre_cuenta", objUtils.GetLimpiarCadena(Fila["nombre_cuenta"].ToString().Trim().ToUpper()));
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_base_gravable", Convert.ToBoolean(Fila["base_gravable"].ToString().Trim()) == true ? "S" : "N");
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_movimiento", Fila["id_movimiento"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_nivel", Fila["idtipo_nivel"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_naturaleza", Fila["idtipo_naturaleza"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_moneda", Fila["idtipo_moneda"].ToString().Trim());
        ...
        public bool GetLoadPuc(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_load_puc", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_row_puc", string.Format("{{{0}}}", string.Join(",", ArrayPuc)));
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idempresa", IdEmpresa);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idusuario", IdUsuario);
                    PgSqlParameter _IdRegRetorno = new PgSqlParameter("@p_out_id_registro", SqlDbType.Int);
                    PgSqlParameter _CodRptaRetorno = new PgSqlParameter("@p_out_cod_rpta", SqlDbType.VarChar);
            ...
            {
                retValor = false;
                _MsgError = "Error al realizar el proceso con el cargue del Puc. Motivo: " + ex.Message.ToString().Trim();
                _log.Error(_MsgError.ToString().Trim());
            }
            finally
            {
        ...
        public bool GetLoadImpuestoPuc(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    #region REGISTRAR INFO EN LA DB DE POSTGRESQL
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_load_impuesto_puc", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
