...
namespace Smartax.Web.Application.Clases.Parametros
{
    public class PucImpuesto
    {
        ...
        public object IdPucImpuesto { get; set; }
        ...
        public DataTable GetAllPucImpuesto()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtPucImpuesto";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_puc_impuesto", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("idpuc_impuesto", typeof(Int32));
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idpuc_impuesto"] = Convert.ToInt32(TheDataReaderPostgreSQL["idpuc_impuesto"].ToString().Trim());
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_puc_impuesto]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetPucImpuesto()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtPucImpuesto";
            try
        ...
        public DataTable GetCuentasPucImpuesto()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtCuentasPucImpuesto";
            try
            {
                #region DEFINICION OBJETO DE CONEXION A LA DB.
                StringBuilder sSQL = new StringBuilder();
            ...
            {
                _log.Error("Error al obtener las cuentas asignadas por impuesto. Motivo: " + ex.Message);
            }
            finally
            {
                #region FINALIZAR OBJETO DE CONEXION
        ...
        public bool AddUpPucImpuesto(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_puc_impuesto", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idpuc_impuesto", IdPucImpuesto);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idpuc", IdPuc);
            ...
            {
                retValor = false;
                _MsgError = "Error al asignar el impuesto a la cuenta. Motivo: " + ex.Message.ToString().Trim();
