...
namespace Smartax.Web.Application.Clases.Parametros
{
    public class Estado
    {
        ...
        public DataTable GetAllEstados()
        {
            ...
            TablaDatos.TableName = "DtEstados";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_estados", (PgSqlConnection)myConnectionDb);
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_estado", TipoEstado);
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_estados";
        ...
        public bool AddUpEstado(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
