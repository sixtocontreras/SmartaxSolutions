...
{
    public class MunicipioImpuestos
    {
        ...
        public object IdMunImpuesto { get; set; }
        public object IdMunicipio { get; set; }
        public object IdFormularioImpuesto { get; set; }
        public object IdFormularioConfig { get; set; }
        ...
        public object OperacionRenglon { get; set; }
        ...
        public DataTable GetAllMunImpuesto()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtMunImpuesto";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_municipio_impuesto", (PgSqlConnection)myConnectionDb);
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idmun_impuesto", IdMunImpuesto);
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["descripcion_periodicidad"] = TheDataReaderPostgreSQL["descripcion_periodicidad"].ToString().Trim();
                            Fila["descripcion_impuesto"] = TheDataReaderPostgreSQL["descripcion_impuesto"].ToString().Trim();

                            int _IdTipoTarifa = Int32.Parse(TheDataReaderPostgreSQL["idtipo_tarifa"].ToString().Trim());
                            Fila["idtipo_tarifa"] = _IdTipoTarifa;
                            Fila["descripcion_tarifa"] = TheDataReaderPostgreSQL["descripcion_tarifa"].ToString().Trim();

                            double _ValorTarifa = Convert.ToDouble(TheDataReaderPostgreSQL["valor_tarifa"].ToString().Trim());
                            Fila["valor_tarifa"] = _ValorTarifa;

                            if (_IdTipoTarifa == 1)
                            {
                                Fila["valor_tarifa"] = TheDataReaderPostgreSQL["valor_tarifa"].ToString().Trim() + "%";
                            }
                            else if (_IdTipoTarifa == 2)
                            {
                                Fila["valor_tarifa"] = TheDataReaderPostgreSQL["valor_tarifa"].ToString().Trim() + "‰";
                            }
                            else
                            {
                                Fila["valor_tarifa"] = String.Format(String.Format("{0:$ ###,###,##0}", _ValorTarifa));
                            }
        ...
        public DataTable GetMunImpuesto()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtMunImpuesto";
            try
            {
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_municipio_impuesto";
        ...
        public DataTable GetInfoMunImpuesto()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtMunImpuesto";
            try
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["id_periodicidad"] = TheDataReaderPostgreSQL["id_periodicidad"].ToString().Trim();
        ...
        public bool AddUpMunImpuesto(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_municipio_impuesto", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idperiodicidad", Fila["id_periodicidad"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_descripcion_impuesto", Fila["descripcion_impuesto"].ToString().Trim().ToUpper());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_tarifa", Fila["idtipo_tarifa"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_valor_tarifa", Fila["valor_tarifa"].ToString().Trim().Replace(",", "."));
        ...
        public bool AddUpMunImpuesto(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idform_configuracion", IdFormularioConfig);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_anio_gravable", AnioGravable);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idperiodicidad", IdPeriodicidad);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_descripcion_impuesto", DescripcionImpuesto);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_operacion_renglon", OperacionRenglon);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_tarifa", IdTipoTarifa);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_valor_tarifa", ValorTarifa);
                    //--RENGLONES MAS OPERACION
        ...
        public bool GetLoadImpMunicipio(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_load_imp_municipios", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
