...
namespace Smartax.Web.Application.Clases.Parametros.Divipola
{
    public class MunicipioBanco
    {
        ...
        public object IdMunicipioBanco { get; set; }
        public object IdMunicipio { get; set; }
        public object IdTipoCuenta { get; set; }
        public object CertificacionBancaria { get; set; }
        ...
        public DataTable GetAllMunicipioBanco()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtMunicipioBanco";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_municipio_banco", (PgSqlConnection)myConnectionDb);
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idmun_banco", IdMunicipioBanco);
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idmunicipio_banco"] = Convert.ToInt32(TheDataReaderPostgreSQL["idmunicipio_banco"].ToString().Trim());
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_municipio_bancos]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public bool AddUpMunicipioBanco(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_municipio_banco", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idmun_banco", IdMunicipioBanco);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idmunicipio", IdMunicipio);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_cuenta", Fila["idtipo_cuenta"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idbanco", Fila["id_banco"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_numero_cuenta", Fila["numero_cuenta"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_certificacion_bancaria", CertificacionBancaria);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idmedio_pago", Fila["idmedio_pago"].ToString().Trim());
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_cheque", Fila["cheque"].ToString().Trim());
            ...
            {
                retValor = false;
                _MsgError = "Error al registrar los bancos del municipio. Motivo: " + ex.Message.ToString().Trim();
        ...
        public bool GetLoadBancoCuentas(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_load_banco_cuentas", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();
            ...
            {
                retValor = false;
                _MsgError = "Error al realizar el proceso con los bancos y cuentas. Motivo: " + ex.Message.ToString().Trim();
                _log.Error(_MsgError.ToString().Trim());
            }
            finally
            {
