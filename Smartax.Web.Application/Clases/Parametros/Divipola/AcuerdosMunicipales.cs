...
{
    public class AcuerdosMunicipales
    {
        ...
        public DataTable GetAllAcuerdos()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtAcuerdos";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_acuerdos_municipales", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("nombre_original_archivo");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idacuerdo_municipal"] = Convert.ToInt32(TheDataReaderPostgreSQL["idacuerdo_municipal"].ToString().Trim());
                            ...
                            Fila["nombre_original_archivo"] = TheDataReaderPostgreSQL["nombre_original_archivo"].ToString().Trim();
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_acuerdos_municipales]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetAcuerdos()
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idacuerdo_municipal");
                    TablaDatos.Columns.Add("nombre_archivo");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idacuerdo_municipal"] = TheDataReaderPostgreSQL["idacuerdo_municipal"].ToString().Trim();
                            Fila["nombre_archivo"] = TheDataReaderPostgreSQL["nombre_archivo"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_acuerdos_municipales";
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        ...
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idacuerdo_municipal"] = TheDataReaderSQLServer["idacuerdo_municipal"].ToString().Trim();
                            Fila["nombre_archivo"] = TheDataReaderSQLServer["nombre_archivo"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                    #endregion
        ...
        public bool AddUpAcuerdo(ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_acuerdo_municipal", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idacuerdo_municipal", IdAcuerdoMunicipal);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idmunicipio", IdMunicipio);
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_nombre_orig_archivo", NombreOrigArchivo);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_nombre_archivo", NombreArchivo);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_fecha_acuerdo", FechaAcuerdo);
