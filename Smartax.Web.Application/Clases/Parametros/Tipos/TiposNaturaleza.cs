...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TiposNaturaleza
    {
        ...
        public object IdTipoNaturaleza { get; set; }
        ...
        public DataTable GetAllTipoNaturaleza()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoNaturaleza";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_naturaleza", (PgSqlConnection)myConnectionDb);
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idtipo_naturaleza"] = Convert.ToInt32(TheDataReaderPostgreSQL["idtipo_naturaleza"].ToString().Trim());
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_tipo_naturaleza";
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_naturaleza"] = Convert.ToInt32(TheDataReaderSQLServer["idtipo_naturaleza"].ToString().Trim());
                            Fila["tipo_naturaleza"] = TheDataReaderSQLServer["tipo_naturaleza"].ToString().Trim();
        ...
        public DataTable GetTipoNaturaleza()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoNaturaleza";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_naturaleza");
                    TablaDatos.Columns.Add("tipo_naturaleza");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_naturaleza"] = TheDataReaderPostgreSQL["idtipo_naturaleza"].ToString().Trim();
                            Fila["tipo_naturaleza"] = TheDataReaderPostgreSQL["tipo_naturaleza"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        ...
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_naturaleza"] = TheDataReaderSQLServer["idtipo_naturaleza"].ToString().Trim();
                            Fila["tipo_naturaleza"] = TheDataReaderSQLServer["tipo_naturaleza"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpTipoNaturaleza(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_tipo_naturaleza", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_naturaleza", IdTipoNaturaleza);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_naturaleza", Fila["tipo_naturaleza"].ToString().Trim().ToUpper());
            ...
            {
                retValor = false;
                _MsgError = "Error al registrar el Tipo de naturaleza. Motivo: " + ex.Message.ToString().Trim();
