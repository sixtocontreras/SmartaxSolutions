...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TipoEvento
    {
        ...
        public DataTable GetAllTipoEvento()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoEvento";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_evento", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("idtipo_evento", typeof(Int32));
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idtipo_evento"] = Convert.ToInt32(TheDataReaderPostgreSQL["idtipo_evento"].ToString().Trim());
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_tipo_evento]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetTipoEvento()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoEvento";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_evento");
                    TablaDatos.Columns.Add("tipo_evento");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_evento"] = TheDataReaderPostgreSQL["idtipo_evento"].ToString().Trim();
                            Fila["tipo_evento"] = TheDataReaderPostgreSQL["tipo_evento"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpTipoEvento(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_cargo", IdTipoEvento);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_cargo", Fila["tipo_evento"].ToString().Trim().ToUpper());
