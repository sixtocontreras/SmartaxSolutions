...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TiposActividad
    {
        ...
        public object IdTipoActividad { get; set; }
        ...
        public DataTable GetAllTipoActividad()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoActividad";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_actividad", (PgSqlConnection)myConnectionDb);
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_tipo_actividad";
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_tipo_actividad]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetTipoActividad()
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_actividad");
                    TablaDatos.Columns.Add("tipo_actividad");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_actividad"] = TheDataReaderPostgreSQL["idtipo_actividad"].ToString().Trim();
                            Fila["tipo_actividad"] = TheDataReaderPostgreSQL["tipo_actividad"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpTipoActividad(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_tipo_actividad", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_actividad", IdTipoActividad);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_actividad", Fila["tipo_actividad"].ToString().Trim().ToUpper());
