...
{
    public class TiposNormatividad
    {
        ...
        public object IdTipoNormatividad { get; set; }
        public string TipoNormatividad { get; set; }
        ...
        public DataTable GetAllTipoNormatividad()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoNormatividad";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_normatividad", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("idtipo_normatividad", typeof(Int32));
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idtipo_normatividad"] = Convert.ToInt32(TheDataReaderPostgreSQL["idtipo_normatividad"].ToString().Trim());
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_tipo_normatividad";
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_normatividad"] = Convert.ToInt32(TheDataReaderSQLServer["idtipo_normatividad"].ToString().Trim());
                            Fila["tipo_normatividad"] = TheDataReaderSQLServer["tipo_normatividad"].ToString().Trim();
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_tipo_normatividad]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetTipoNormatividad()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoNormatividad";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_normatividad");
                    TablaDatos.Columns.Add("tipo_normatividad");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_normatividad"] = TheDataReaderPostgreSQL["idtipo_normatividad"].ToString().Trim();
                            Fila["tipo_normatividad"] = TheDataReaderPostgreSQL["tipo_normatividad"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        ...
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_normatividad"] = TheDataReaderSQLServer["idtipo_normatividad"].ToString().Trim();
                            Fila["tipo_normatividad"] = TheDataReaderSQLServer["tipo_normatividad"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpTipoNormatividad(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_tipo_normatividad", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_normatividad", IdTipoNormatividad);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_normatividad", Fila["tipo_normatividad"].ToString().Trim().ToUpper());
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer = new SqlCommand();
                    TheCommandSQLServer.CommandText = "sp_web_crud_tipo_normatividad";
                    TheCommandSQLServer.CommandType = CommandType.StoredProcedure;
                    TheCommandSQLServer.Connection = (System.Data.SqlClient.SqlConnection)myConnectionDb;
                    //se limpian los parámetros
                    TheCommandSQLServer.Parameters.Clear();

                    TipoNormatividad = Fila["tipo_normatividad"].ToString().Trim().ToUpper();
                    TheCommandSQLServer.Parameters.AddWithValue("@p_in_idtipo_normatividad", IdEstado);
                    TheCommandSQLServer.Parameters.AddWithValue("@p_in_tipo_normatividad", Fila["descripcion_estado"].ToString().Trim());
                    ...
                    if (Valor_Retornado >= 1)
                    {
                        if (TipoProceso == 1)
                        {
                            ...
                            _MsgError = "El tipo de normatividad [" + TipoNormatividad + "] ha sido registrado exitosamente.";
                        }
                        else if (TipoProceso == 2)
                        {
                            _MsgError = "El tipo de normatividad [" + TipoNormatividad + "] han sido editados exitosamente.";
                        }
                        else if (TipoProceso == 3)
                        {
                            _MsgError = "El tipo de normatividad [" + TipoNormatividad + "] ah sido eliminado del sistema.";
                        }
            ...
            {
                retValor = false;
                _MsgError = "Error al registrar el tipo de normatividad. Motivo: " + ex.Message.ToString().Trim();
