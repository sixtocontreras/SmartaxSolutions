...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TiposFirma
    {
        ...
        public object IdTipoFirma { get; set; }
        ...
        public DataTable GetAllTipoFirma()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoFirma";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_firma", (PgSqlConnection)myConnectionDb);
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_tipo_firma";
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_firma"] = Convert.ToInt32(TheDataReaderSQLServer["idtipo_firma"].ToString().Trim());
                            Fila["tipo_firma"] = TheDataReaderSQLServer["tipo_firma"].ToString().Trim();
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_tipo_firma]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetTipoFirma()
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_firma");
                    TablaDatos.Columns.Add("tipo_firma");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_firma"] = TheDataReaderPostgreSQL["idtipo_firma"].ToString().Trim();
                            Fila["tipo_firma"] = TheDataReaderPostgreSQL["tipo_firma"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpTipoFirma(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_tipo_firma", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_firma", IdTipoFirma);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_firma", Fila["tipo_firma"].ToString().Trim().ToUpper());
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer = new SqlCommand();
                    TheCommandSQLServer.CommandText = "sp_web_crud_tipo_firma";
                    TheCommandSQLServer.CommandType = CommandType.StoredProcedure;
                    TheCommandSQLServer.Connection = (System.Data.SqlClient.SqlConnection)myConnectionDb;
                    //se limpian los parámetros
                    TheCommandSQLServer.Parameters.Clear();

                    TipoFirma = Fila["tipo_firma"].ToString().Trim().ToUpper();
                    TheCommandSQLServer.Parameters.AddWithValue("@p_in_idtipo_firma", IdEstado);
                    TheCommandSQLServer.Parameters.AddWithValue("@p_in_tipo_firma", Fila["descripcion_estado"].ToString().Trim());
                    ...
                    if (Valor_Retornado >= 1)
                    {
                        if (TipoProceso == 1)
                        {
                            ...
                            _MsgError = "El tipo de firma [" + TipoFirma + "] ha sido registrado exitosamente.";
                        }
                        else if (TipoProceso == 2)
                        {
                            _MsgError = "El tipo de firma [" + TipoFirma + "] han sido editados exitosamente.";
                        }
                        else if (TipoProceso == 3)
                        {
                            _MsgError = "El tipo de firma [" + TipoFirma + "] ah sido eliminado del sistema.";
                        }
