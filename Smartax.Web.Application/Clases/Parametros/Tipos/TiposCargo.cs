...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TiposCargo
    {
        ...
        public object IdTipoCargo { get; set; }
        ...
        public DataTable GetAllTipoCargo()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoCargo";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_cargo", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("idtipo_cargo", typeof(Int32));
                    TablaDatos.Columns.Add("tipo_cargo");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idtipo_cargo"] = Convert.ToInt32(TheDataReaderPostgreSQL["idtipo_cargo"].ToString().Trim());
                            Fila["tipo_cargo"] = TheDataReaderPostgreSQL["tipo_cargo"].ToString().Trim();
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_tipo_cargo";
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_cargo"] = Convert.ToInt32(TheDataReaderSQLServer["idtipo_cargo"].ToString().Trim());
                            Fila["tipo_cargo"] = TheDataReaderSQLServer["tipo_cargo"].ToString().Trim();
        ...
        public DataTable GetTipoCargo()
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_cargo");
                    TablaDatos.Columns.Add("tipo_cargo");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_cargo"] = TheDataReaderPostgreSQL["idtipo_cargo"].ToString().Trim();
                            Fila["tipo_cargo"] = TheDataReaderPostgreSQL["tipo_cargo"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpTipoCargo(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_cargo", Fila["tipo_cargo"].ToString().Trim().ToUpper());
