...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TipoIdentificacion
    {
        ...
        public object IdTipoIdentificacion { get; set; }
        ...
        public DataTable GetAllTipoIde()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTiposIdentificacion";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_identificacion", (PgSqlConnection)myConnectionDb);
        ...
        public DataTable GetIdentificacion()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTiposIdentificacion";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_identificacion");
                    TablaDatos.Columns.Add("tipo_identificacion");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_identificacion"] = TheDataReaderPostgreSQL["idtipo_identificacion"].ToString().Trim();
                            Fila["tipo_identificacion"] = TheDataReaderPostgreSQL["tipo_identificacion"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        ...
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_identificacion"] = TheDataReaderSQLServer["idtipo_identificacion"].ToString().Trim();
                            Fila["tipo_identificacion"] = TheDataReaderSQLServer["tipo_identificacion"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
                    #endregion
        ...
        public bool AddUpIdentificacion(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_tipo_identificacion", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_identificacion", IdTipoIdentificacion);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_identificacion", Fila["tipo_identificacion"].ToString().Trim().ToUpper());
