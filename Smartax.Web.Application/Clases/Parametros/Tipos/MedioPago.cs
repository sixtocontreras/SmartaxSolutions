...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class MedioPago
    {
        ...
        public object IdMedioPago { get; set; }
        public string MedioPagos { get; set; }
        ...
        public DataTable GetAllMedioPago()
        {
            ...
            TablaDatos.TableName = "DtMedioPago";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_medio_pago", (PgSqlConnection)myConnectionDb);
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idmedio_pago"] = Convert.ToInt32(TheDataReaderPostgreSQL["idmedio_pago"].ToString().Trim());
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_medio_pago]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetMedioPago()
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idmedio_pago");
                    TablaDatos.Columns.Add("medio_pago");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idmedio_pago"] = TheDataReaderPostgreSQL["idmedio_pago"].ToString().Trim();
                            Fila["medio_pago"] = TheDataReaderPostgreSQL["medio_pago"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpMedioPago(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_cargo", IdMedioPago);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_tipo_cargo", Fila["medio_pago"].ToString().Trim().ToUpper());
