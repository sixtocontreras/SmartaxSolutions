...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class DiasFestivo
    {
        ...
        public object IdDiaFestivo { get; set; }
        public string DiaFestivo { get; set; }
        public string Anio { get; set; }
        public string Mes { get; set; }
        public string DescripcionFestivo { get; set; }
        ...
        public DataTable GetAllDiasFestivo()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtDiasFestivo";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_dias_festivo", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("iddia_festivo", typeof(Int32));
                    TablaDatos.Columns.Add("dia_festivo");
                    TablaDatos.Columns.Add("descripcion_festivo");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["iddia_festivo"] = Convert.ToInt32(TheDataReaderPostgreSQL["iddia_festivo"].ToString().Trim());
                            Fila["dia_festivo"] = TheDataReaderPostgreSQL["dia_festivo"].ToString().Trim();
                            Fila["descripcion_festivo"] = TheDataReaderPostgreSQL["descripcion_festivo"].ToString().Trim();
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer.CommandText = "sp_web_get_dias_festivo";
                    ...
                    if (TheDataReaderSQLServer != null)
                    {
                        while (TheDataReaderSQLServer.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["iddia_festivo"] = Convert.ToInt32(TheDataReaderSQLServer["iddia_festivo"].ToString().Trim());
                            Fila["dia_festivo"] = TheDataReaderSQLServer["dia_festivo"].ToString().Trim();
                            Fila["descripcion_festivo"] = TheDataReaderSQLServer["descripcion_festivo"].ToString().Trim();
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_dias_festivo]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetDiasFestivo()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtDiasFestivo";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("iddia_festivo");
                    TablaDatos.Columns.Add("fecha_festivo");
                    TablaDatos.Columns.Add("dia_festivo");
                    TablaDatos.Columns.Add("mes_festivo");
                    TablaDatos.Columns.Add("descripcion_festivo");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["iddia_festivo"] = TheDataReaderPostgreSQL["iddia_festivo"].ToString().Trim();
                            Fila["fecha_festivo"] = TheDataReaderPostgreSQL["fecha_festivo"].ToString().Trim();
                            Fila["dia_festivo"] = TheDataReaderPostgreSQL["dia_festivo"].ToString().Trim();
                            Fila["mes_festivo"] = TheDataReaderPostgreSQL["mes_festivo"].ToString().Trim();
                            Fila["descripcion_festivo"] = TheDataReaderPostgreSQL["descripcion_festivo"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpDiaFestivo(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_dia_festivo", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_iddia_festivo", IdDiaFestivo);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_dia_festivo", Convert.ToDateTime(Fila["dia_festivo"].ToString().Trim()).ToString("yyyy-MM-dd"));
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_descripcion", Fila["descripcion_festivo"].ToString().Trim().ToUpper());
                ...
                else if (myConnectionDb is SqlConnection)
                {
                    ...
                    TheCommandSQLServer = new SqlCommand();
                    TheCommandSQLServer.CommandText = "sp_web_crud_dia_festivo";
                    TheCommandSQLServer.CommandType = CommandType.StoredProcedure;
                    TheCommandSQLServer.Connection = (System.Data.SqlClient.SqlConnection)myConnectionDb;
                    //se limpian los parámetros
                    TheCommandSQLServer.Parameters.Clear();

                    DiaFestivo = Fila["dia_festivo"].ToString().Trim().ToUpper();
                    TheCommandSQLServer.Parameters.AddWithValue("@p_in_dia_festivo", Convert.ToDateTime(Fila["dia_festivo"].ToString().Trim()).ToString("yyyy-MM-dd"));
                    TheCommandSQLServer.Parameters.AddWithValue("@p_in_descripcion", Fila["descripcion_festivo"].ToString().Trim().ToUpper());
                    ...
                    if (Valor_Retornado >= 1)
                    {
                        if (TipoProceso == 1)
                        {
                            ...
                            _MsgError = "El dia festivo [" + DiaFestivo + "] ha sido registrado exitosamente.";
                        }
                        else if (TipoProceso == 2)
                        {
                            _MsgError = "El dia festivo [" + DiaFestivo + "] han sido editados exitosamente.";
                        }
                        else if (TipoProceso == 3)
                        {
                            _MsgError = "El dia festivo [" + DiaFestivo + "] ah sido eliminado del sistema.";
                        }
            ...
            {
                retValor = false;
                _MsgError = "Error al registrar el Tipo de cargo. Motivo: " + ex.Message.ToString().Trim();
