...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TipoCuenta
    {
        ...
        public object IdTipoCuenta { get; set; }
        ...
        public DataTable GetAllTipoCuenta()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoCuenta";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_get_tipo_cuenta", (PgSqlConnection)myConnectionDb);
                    ...
                    TablaDatos.Columns.Add("descripcion_cuenta");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            ...
                            Fila["idtipo_cuenta"] = Convert.ToInt32(TheDataReaderPostgreSQL["idtipo_cuenta"].ToString().Trim());
                            Fila["descripcion_cuenta"] = TheDataReaderPostgreSQL["descripcion_cuenta"].ToString().Trim();
            ...
            {
                _log.Error("Error al obtener los datos de la Tabla [tbl_tipo_cuenta]. Motivo: " + ex.Message);
            }
            finally
            {
        ...
        public DataTable GetTipoCuenta()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoCuenta";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_cuenta");
                    TablaDatos.Columns.Add("descripcion_cuenta");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_cuenta"] = TheDataReaderPostgreSQL["idtipo_cuenta"].ToString().Trim();
                            Fila["descripcion_cuenta"] = TheDataReaderPostgreSQL["descripcion_cuenta"].ToString().Trim();
                            TablaDatos.Rows.Add(Fila);
                        }
                    }
        ...
        public bool AddUpTipoCargo(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            ...
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_tipo_cuenta", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipo_cuenta", IdTipoCuenta);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_descripcion", Fila["descripcion_cuenta"].ToString().Trim().ToUpper());
            ...
            {
                retValor = false;
                _MsgError = "Error al registrar el Tipo de cuenta. Motivo: " + ex.Message.ToString().Trim();
