...
namespace Smartax.Web.Application.Clases.Parametros.Tipos
{
    public class TipoLicencia
    {
        ...
        private object _IdTipoLicencia;
        ...
        public DataTable GetAllTipoLicencia()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoLicencia";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_datos_all_tipo_licencia", (PgSqlConnection)myConnectionDb);
        ...
        public DataTable GetTipoLicencia()
        {
            DataTable TablaDatos = new DataTable();
            TablaDatos.TableName = "DtTipoLicencia";
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    TablaDatos.Columns.Add("idtipo_licencia");
                    TablaDatos.Columns.Add("tipo_licencia");
                    ...
                    if (TheDataReaderPostgreSQL != null)
                    {
                        ...
                        while (TheDataReaderPostgreSQL.Read())
                        {
                            DataRow Fila = null;
                            Fila = TablaDatos.NewRow();
                            Fila["idtipo_licencia"] = TheDataReaderPostgreSQL["idtipo_licencia"].ToString().Trim();
                            Fila["tipo_licencia"] = TheDataReaderPostgreSQL["tipo_licencia"].ToString().Trim();
        ...
        public bool AddUpTipoLicencia(DataRow Fila, ref int _IdRegistro, ref string _MsgError)
        {
            bool retValor = false;
            try
            {
                ...
                if (myConnectionDb is PgSqlConnection)
                {
                    ...
                    IDbTransaction Transac = myConnectionDb.BeginTransaction();
                    TheCommandPostgreSQL = new PgSqlCommand("sp_web_crud_tipo_licencia", (PgSqlConnection)myConnectionDb);
                    TheCommandPostgreSQL.CommandType = CommandType.StoredProcedure;
                    //Limpiar parametros
                    TheCommandPostgreSQL.Parameters.Clear();

                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_idtipolicencia", IdTipoLicencia);
                    TheCommandPostgreSQL.Parameters.AddWithValue("@p_in_descripcion", Fila["tipo_licencia"].ToString().Trim().ToUpper());
